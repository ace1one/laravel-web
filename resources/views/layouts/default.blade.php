...
<body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-4 col-md-8 text-end mt-2">
                        <ul class="list-inline">
                            <li>
                                <a href="mailto:"><i class="livicon align-top" data-name="mail" data-size="18"
                            ...
                            <li>
                                <a href="tel:"><i class="livicon align-top" data-name="phone" data-size="18"
                                        data-loop="true" data-c="#fff" data-hc="#fff"></i></a>
                                <label class="d-none d-md-inline-block d-lg-inline-block d-xl-inline-block"><a
    ...
    <footer>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4 col-12">
                        ...
                        <div class="media d-flex align-items-start">
                            <img class="media-object rounded-circle me-3" src="{{ asset('images/image_14.jpg') }}"
                                alt="image">
                        ...
                        <div class="media d-flex align-items-start">
                            <img class="media-object rounded-circle me-3" src="{{ asset('images/image_15.jpg') }}"
                                alt="image">
                        ...
                        <div class="media d-flex align-items-start">
                            <img class="media-object rounded-circle me-3" src="{{ asset('images/image_13.jpg') }}"
                                alt="image">
                            <div class="media-body">
                                <p class="media-heading text-justify">Lorem Ipsum is simply dummy text of the printing
                                    and type setting
        ...
        <div class=" col-12 copyright">
            <div class="container">
                <p>Copyright &copy; Josh Admin Template, 2024</p>
            </div>
        </div>
    </footer>
