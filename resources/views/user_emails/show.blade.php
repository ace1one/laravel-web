...
@if ($unread_mails_count > 0)
                                            <span
class="badge rounded-pill bg-success float-end mt-1">{{ $unread_mails_count }}</span>
                                        @endif
                                    </a>
                                </li>
                                <li>
                                        ...
                                        <td>
                                            <div class="row nopadmar">
                                                ...
                                                <div class="col-6 col-sm-4 no-padding col-md-3 mt-3 col-lg-3 col-xl-2">
                                                    <a href="{{ URL::to('user_emails/' . $email->id . '/reply') }}"
                                                ...
                                                <div class="col-6 col-sm-4 no-padding col-md-3 mt-3 col-lg-3 col-xl-2">
                                                    <a href="{{ URL::to('user_emails/' . $email->id . '/forward') }}"
