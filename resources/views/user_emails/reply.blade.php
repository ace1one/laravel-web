...
@if ($unread_mails_count > 0)
                                        <span class="badge bg-success float-end bg-pill mt-1">{{ $unread_mails_count }}</span>
                                        @endif
                                    </a>
                                </li>
                                <li>
                                        ...
                                        <div class="form-group  {{ $errors->first('email_id', 'has-error') }}">
                                            ...
                                            <div class="col-xs-9">
                                                <input type="email" name="email_id" class="form-control required"
                                                    id="email_id" placeholder="Email id" value="{!! old('subject', $email->senderName->email) !!}"
                                                    tabindex="1">
