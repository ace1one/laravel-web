                        ...
                        <div class="flatbuttons">
                            <div class="text-start">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="#"
                                            class="btn btn-raised btn-success hvr-wobble-horizontal">Horizontal</a>
                                    </li>
                                    <li>
                            ...
                            <div class="text-start">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="#" class="btn btn-raised btn-info hvr-shutter-in-horizontal">Shutter
                                            In</a>
                                    </li>
                                    <li>
                            ...
                            <div class="text-start">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="#" class="btn btn-raised btn-secondary hvr-bubble-right">Bubble
                                            right</a>
                                    </li>
                                    <li>
                                        <a href="#" class="btn btn-raised btn-secondary hvr-bubble-float-top">Float
                                            top</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="btn btn-raised btn-secondary  hvr-bubble-float-bottom">Float
                                            bottom</a>
                                    </li>
                                    <li>
                            ...
                            <div class="text-start">
                                ...
                                <ul>
                                    <li>
                                        <a href="#" class="btn btn-raised btn-secondary hvr-curl-top-left">Top
                                            left</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="#" class="btn btn-raised btn-success hvr-curl-bottom-left">bottom
                                            left</a>
                                    </li>
                                    <li>
            ...
            <div class="col-md-12 col-12 col-lg-6 my-3">
                ...
                <div class="card ">
                    ...
                    <div class="card-body text-center">
                        <!--content starts-->
                        <div class="wrap">
                            <span id="animationSandbox1" class="m-0">
                                <span class="site__title mega">JOSH</span>
                            </span>
                        </div>
                        <div class="wrap">
                            <p>
                                <select id="s1" class="js--animations form-select"
                                    onchange="testAnim(this.value,1);">
                ...
                <div class="card  my-3">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="wrap">
                            <p>
                                <select id="s2" class="js--animations form-select"
                                    onchange="testAnim(this.value,2);">
                ...
                <div class="card my-3">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="wrap">
                            <p>
                                <select id="s3" class="js--animations form-select"
                                    onchange="testAnim(this.value,3);">
                ...
                <div class="card my-3">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="wrap">
                            <p>
                                <select id="s4" class="js--animations form-select"
                                    onchange="testAnim(this.value,4);">
                ...
                <div class="card  my-3">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="wrap">
                            <p>
                                <select id="s5" class=" js--animations form-select"
                                    onchange="testAnim(this.value,5);">
                ...
                <div class="card  my-3">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="wrap">
                            <p>
                                <select id="s6" class=" js--animations form-select"
                                    onchange="testAnim(this.value,6);">
            ...
            <div class="col-md-12 col-12 col-lg-6 my-3">
                ...
                <div class="card ">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="wrap">
                            <p>
                                <select id="s7" class=" js--animations form-select"
                                    onchange="testAnim(this.value,7);">
                ...
                <div class="card  my-3">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="wrap">
                            <p>
                                <select id="s8" class=" js--animations form-select"
                                    onchange="testAnim(this.value,8);">
                ...
                <div class="card my-3">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="wrap">
                            <p>
                                <select id="s9" class=" js--animations form-select"
                                    onchange="testAnim(this.value,9);">
                ...
                <div class="card ">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="wrap">
                            <p>
                                <select id="s10" class=" js--animations form-select"
                ...
                <div class="card my-3">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="wrap">
                            <p>
                                <select id="s11" class=" js--animations form-select"
