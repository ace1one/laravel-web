<ul id="menu" class="metismenu page-sidebar-menu">
    ...
    <li {!! Request::is('admin/datatables') ||
    Request::is('admin/editable_datatables') ||
    Request::is('admin/dropzone') ||
    Request::is('admin/custom_datatables') ||
    Request::is('admin/selectfilter')
        ? 'class="mm-active"'
        : '' !!}>
        <a href="#">
    ...
    <li {!! Request::is('admin/laravel_charts') || Request::is('admin/database_charts') ? 'class="mm-active"' : '' !!}>
        <a href="#">
    ...
    <li {!! Request::is('admin/form_builder') ||
    Request::is('admin/form_builder2') ||
    Request::is('admin/buttonbuilder') ||
    Request::is('admin/gridmanager')
        ? 'class="mm-active"'
        : '' !!}>
        <a href="#">
    ...
    <li {!! Request::is('admin/form_examples') ||
    Request::is('admin/editor') ||
    Request::is('admin/editor2') ||
    Request::is('admin/form_layout') ||
    Request::is('admin/validation') ||
    Request::is('admin/formelements') ||
    Request::is('admin/dropdowns') ||
    Request::is('admin/radio_checkbox') ||
    Request::is('admin/ratings') ||
    Request::is('admin/form_layouts') ||
    Request::is('admin/formwizard') ||
    Request::is('admin/accordionformwizard') ||
    Request::is('admin/datepicker') | Request::is('admin/advanced_datepickers')
        ? 'class="mm-active"'
        : '' !!}>
        <a href="#">
        ...
        <ul class="sub-menu">
            ...
            <li {!! Request::is('admin/tailselect') ? 'class="active"' : '' !!}>
                <a href="{{ URL::to('admin/tailselect') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Form Elements Select I
                </a>
            </li>
            <li {!! Request::is('admin/tomselect') ? 'class="active"' : '' !!}>
                <a href="{{ URL::to('admin/tomselect') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Form Elements Select II
                </a>
            </li>
    ...
    <li {!! Request::is('admin/animatedicons') ||
    Request::is('admin/buttons') ||
    Request::is('admin/advanced_buttons') ||
    Request::is('admin/tabs_accordions') ||
    Request::is('admin/cards') ||
    Request::is('admin/icon') ||
    Request::is('admin/color') ||
    Request::is('admin/grid') ||
    Request::is('admin/carousel') ||
    Request::is('admin/tagsinput') ||
    Request::is('admin/nestable_list') ||
    Request::is('admin/sortable_list') ||
    Request::is('admin/toastr') ||
    Request::is('admin/notifications') ||
    Request::is('admin/treeview_jstree') ||
    Request::is('admin/sweetalert') ||
    Request::is('admin/session_timeout') ||
    ...
    <li {!! Request::is('admin/general') ||
    Request::is('admin/modals') ||
    Request::is('admin/pickers') ||
    Request::is('admin/x-editable') ||
    Request::is('admin/timeline') ||
    Request::is('admin/animations') ||
    Request::is('admin/sliders') ||
    Request::is('admin/knob')
        ? 'class="mm-active"'
        : '' !!}>
        <a href="#">
    ...
    <li {!! Request::is('admin/simple_table') ||
    Request::is('admin/responsive_tables') ||
    Request::is('admin/advanced_tables') ||
    Request::is('admin/advanced_tables2') ||
    Request::is('admin/jtable')
        ? 'class="mm-active"'
        : '' !!}>
        <a href="#">
    ...
    <li {!! Request::is('admin/apexcharts') ||
    !!Request::is('admin/charts') ||
    Request::is('admin/piecharts') ||
    Request::is('admin/charts_animation') ||
    Request::is('admin/jscharts') ||
    Request::is('admin/sparklinecharts') ||
    Request::is('admin/tui-charts')
        ? 'class="mm-active"'
        : '' !!}>
        <a href="#">
        ...
        <ul class="sub-menu">
            <li {!! Request::is('admin/apexcharts') ? 'class="active"' : '' !!}>
                <a href="{{ URL::to('admin/apexcharts') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Apex Charts
                </a>
            </li>
            ...
            <li {!! Request::is('admin/tui-charts') ? 'class="active"' : '' !!}>
                <a href="{{ URL::to('admin/tui-charts') }}">
                    <i class="fa fa-angle-double-right"></i>
                    ToastUI Charts
                </a>
            </li>
    ...
    <li {!! Request::is('admin/calendar') ? 'class="active"' : '' !!}>
        <a href="{{ URL::to('admin/calendar') }}">
            <i class="livicon" data-c="#F89A14" data-hc="#F89A14" data-name="calendar" data-size="18"
                data-loop="true"></i>
            Calendar
            <span class="badge bg-danger event_count">7</span>
        </a>
    </li>
    <li {!! Request::is('admin/emails/inbox') || Request::is('admin/emails/compose') || Request::is('admin/emails/sent')
        ? 'class="menu-dropdown mm-active"'
        : "class='menu-dropdown'" !!}>
        <a href="#">
    ...
    <li {!! Request::is('admin/tasks') ? 'class="active"' : '' !!}>
        <a href="{{ URL::to('admin/tasks') }}">
            <i class="livicon" data-c="#EF6F6C" data-hc="#EF6F6C" data-name="list-ul" data-size="18"
                data-loop="true"></i>
            Tasks
            <span class="badge bg-danger" id="taskcount">{{ Request::get('tasks_count') }}</span>
        </a>
    </li>
    <li {!! Request::is('admin/gallery') ||
    Request::is('admin/masonry_gallery') ||
    Request::is('admin/imagecropping') ||
    Request::is('admin/imgmagnifier')
        ? 'class="mm-active"'
        : '' !!}>
        <a href="#">
    ...
    <li {!! Request::is('admin/googlemaps') || Request::is('admin/vectormaps') || Request::is('admin/advancedmaps')
        ? 'class="mm-active"'
        : '' !!}>
        <a href="#">
    ...
    <li {!! Request::is('admin/blogcategory') ||
    Request::is('admin/blogcategory/create') ||
    Request::is('admin/blog') ||
    Request::is('admin/blog/create') ||
    Request::is('admin/blog/*') ||
    Request::is('admin/blogcategory/*')
        ? 'class="mm-active"'
        : '' !!}>
        <a href="#">
    ...
    <li {!!Request::is('admin/notice') ||
    Request::is('admin/notice/create') ||
    Request::is('admin/notice/*')
        ...
        <ul class="sub-menu">
            ...
            <li {!! Request::is('admin/notice/create') ? 'class="active"' : '' !!}>
    ...
    <li {!! Request::is('admin/invoice') || Request::is('admin/blank') ? 'class="mm-active"' : '' !!}>
        <a href="#">
