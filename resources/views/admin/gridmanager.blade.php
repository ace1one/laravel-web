...
@section('content')
    ...
    <section class="content px-3">
        <div class="alert alert-success alert-dismissible visible-xs visible-md">
                    ...
                    <div class="col-12">
                        <div id="mycanvas">
                            <div class='row'>
                                <div class="col-12">
                                    <p>
                                        <img data-src="holder.js/1900x100/#418bca:#fff" class='img-fluid'>
                                    </p>
                                </div>
                            </div>
                            <div class='row my-3'>
                                <div class='col-md-6 col-lg-6 col-12 w-100 '>
                                    ...
                                    <p>
                                        ...
                                        convallis tincidunt placerat. Duis posuere leo quis tincidunt iaculis. Vestibulum
                                        pulvinar, neque quis cursus rhoncus, justo mi dictum enim, non facilisis ligula
                                        justo eleifend felis. Donec velit nibh, egestas eu sapien at, bibendum consectetur
                                        urna. Donec tincidunt vitae erat vitae congue.
                                    </p>
                                </div>
                                <div class='col-md-6 col-lg-6 col-12 w-100 '>
                                    <h2>2-Column Row</h2>
                            ...
                            <div class='row'>
                                <div class='column col-md-4'>
                                    ...
                                    <p>
                                        ...
                                        Pellentesque at mauris non tortor elementum pretium. Integer rutrum libero at
                                        facilisis interdum. Praesent lobortis elit erat, quis elementum justo rhoncus eu. Ut
                                        eu dui lectus. Duis faucibus eu augue ut placerat.
                                    </p>
                                </div>
                                <div class='column col-md-4'>
                                    <h3>3-Column Row</h3>
                            ...
                            <div class='row'>
                                <div class='column col-md-3'>
                                    <p>
                                        <img data-src="holder.js/400x150/#00bc8c:#fff" class='img-fluid'>
                                    </p>
                                    <h4>4-Column Row</h4>
                                    <p>
                                        Vivamus faucibus nibh ut aliquam dignissim. Nunc tempus velit sit amet eleifend
                                ...
                                <div class='column col-md-3'>
                                    <p>
                                        <img data-src="holder.js/400x150/#5bc0de:#fff" class='img-fluid'>
                                    </p>
                                    <h4>4-Column Row</h4>
                                    <p>
                                        Vivamus faucibus nibh ut aliquam dignissim. Nunc tempus velit sit amet eleifend
                                ...
                                <div class='column col-md-3'>
                                    <p>
                                        <img data-src="holder.js/400x150/#EF6F6C:#fff" class='img-fluid'>
                                    </p>
                                    <h4>4-Column Row</h4>
                                    <p>
                                        Vivamus faucibus nibh ut aliquam dignissim. Nunc tempus velit sit amet eleifend
