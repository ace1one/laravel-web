    ...
    <section class="content  px-3">
        ...
        <div class="row">
            <div class="col-md-12 news-page">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div id="myCarousel" class="carousel image-carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-indicators">
                                <div data-bs-target="#myCarousel" data-bs-slide-to="0" class="active"></div>
                                <div data-bs-target="#myCarousel" data-bs-slide-to="1"></div>
                                <div data-bs-target="#myCarousel" data-bs-slide-to="2"></div>
                            </div>
                        </div>
                        ...
                        <div class="news-blocks">
                            ...
                            <p>
                                <img class="news-block-img float-end" data-src="holder.js/70x70/#EF6F6C:#fff"
                                    alt="">The
                        ...
                        <div class="news-blocks">
                            ...
                            <p>
                                <img class="news-block-img float-end" data-src="holder.js/70x70/#418bca:#fff"
                                    alt="">Su
                        ...
                        <div class="news-blocks">
                            <h3>
                                <a href="{{ URL::to('admin/news_item') }}">U.S. surges past Canada at World Lacrosse
                                    games</a>
                            </h3>
                            ...
                            <p>
                                <img class="news-block-img float-end" data-src="holder.js/70x70/#A9B6BC:#fff"
                                    alt="">COMMERCE
                    ...
                    <div class="col-md-3">
                        <div class="news-blocks">
                            <h3>
                                <a href="{{ URL::to('admin/news_item') }}">Futures Game: Gallo gives US 3-2 win over
                                    World</a>
                            </h3>
                            ...
                            <p>
                                <img class="news-block-img float-end" data-src="holder.js/70x70/#00bc8c:#fff"
                                    alt="">MINNEAPOLIS
                        ...
                        <div class="news-blocks">
                            <h3>
                                <a href="{{ URL::to('admin/news_item') }}">World Cup 2014: 11 things the tournament taught
                                    us</a>
                            </h3>
                            ...
                            <p>
                                <img class="news-block-img float-end" data-src="holder.js/70x70/#67cc5df:#fff"
                                    alt="">Plenty
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="news-blocks">
                                    <h3>
                                        <a href="{{ URL::to('admin/news_item') }}">Dying patients 'bewildered by array of
                                            services'</a>
                                    </h3>
                                    ...
                                    <p>
                                        <img class="news-block-img float-end" data-src="holder.js/70x70/#418bca:#fff"
                                            alt="">The study into multimorbidity - several illnesses at the same
                                        time -
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="news-blocks">
                                    <h3>
                                        <a href="{{ URL::to('admin/news_item') }}">Record number of data complaints made
                                            to ICO</a>
                                    </h3>
