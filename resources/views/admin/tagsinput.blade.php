                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <div class="example example_tagclass">
                            ...
                            <p>
                                You can set a fixed css class for your tags, or determine dynamically by provinding a custom
                                function.
                            </p>
                            <div class="bs-example">
                            ...
                            <div class="accordion accordion-flush">
                                <div class="accordion-item">
                                    ...
                                    <div id="accordion_example_tagclass" class="accordion-collapse collapse">
              ...
              $('input').tagsinput({
                tagClass: function(item) {
                  switch (item.continent) {
                    case 'Europe'   : return 'badge bg-primary';
                    case 'America'  : return 'badge bg-danger';
                    case 'Australia': return 'badge bg-success';
                    case 'Africa'   : return 'badge bg-primary';
                    case 'Asia'     : return 'badge bg-warning';
                  }
                },
                itemValue: 'value',
                itemText: 'text'
                    ...
                    <div class="card-body">
                        <div class="example example_multivalue">
                            ...
                            <p>
                                ...
                                as your input element for a tags input, to gain true multivalue support. Instead of a comma
                        ...
                        <div class="box-body">
                            <div class="example example_objects_as_tags">
                                ...
                                <p>
                                    ...
                                    possible to set id values in your input field's value, instead of just the tag's text.
                                </p>
                                <div class="bs-example">
                                ...
                                <div class="accordion accordion-flush">
                                    <div class="accordion-item">
                                        ...
                                        <div id="accordion_example_objects_as_tags" class="accordion-collapse collapse">
                                            <div class="accordion-body">
                                                <pre class="prettyprint linenums">&lt;input type=&quot;text&quot; /&gt;
&lt;script&gt;
$('input').tagsinput({
                        ...
                        <div class="example example_typeahead">
                            ...
                            <div class="accordion  accordion-flush">
                                <div class="accordion-item">
                                    <div class="accordion-header">
                                        <a class="accordion-toggle" data-bs-toggle="collapse"
                                            href="#example_typeahead">Show
                                            code</a>
                                    </div>
                                    <div id="example_typeahead" class="accordion-collapse collapse">
                                        <div class="accordion-body">
