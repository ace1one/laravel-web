...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.css') }}" />
                    ...
                    <div class="card-header bg-success text-white">
                        <span>
                            <i class="livicon" data-name="rocket" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Dismissable alerts
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
                    ...
                    <div class="card-header bg-info text-white">
                        <span>
                            <i class="livicon" data-name="sky-dish" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Links in alerts
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
        ...
        <div class="row">
                ...
                <div class="card ">
                    <div class="card-header bg-danger text-white ">
                        <span>
                            <i class="livicon" data-name="spinner-two" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Themed Progressbars
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
                    ...
                    <div class="card-body c2">
                        <div class="progress" role="progressbar">
                            <div class="progress-bar bg-primary" data-transitiongoal="20"></div>
                        </div>
                        <div class="progress" role="progressbar">
                            <div class="progress-bar bg-info" data-transitiongoal="40"></div>
                        </div>
                        <div class="progress" role="progressbar">
                            <div class="progress-bar bg-success" data-transitiongoal="60"></div>
                        </div>
                        <div class="progress" role="progressbar">
                            <div class="progress-bar bg-warning" data-transitiongoal="80"></div>
                        </div>
                        <div class="progress" role="progressbar">
                            <div class="progress-bar bg-danger" data-transitiongoal="100"></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-info text-white">
                        <span>
                            <i class="livicon" data-name="spinner-three" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Striped progressbars
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
                    ...
                    <div class="card-body c2">
                        <div class="progress" role="progressbar">
                            <div class="progress-bar progress-bar-striped bg-primary" data-transitiongoal="20"></div>
                        </div>
                        <div class="progress" role="progressbar">
                            <div class="progress-bar progress-bar-striped bg-info" data-transitiongoal="40"></div>
                        </div>
                        <div class="progress" role="progressbar">
                            <div class="progress-bar progress-bar-striped bg-success" data-transitiongoal="60"></div>
                        </div>
                        <div class="progress" role="progressbar">
                            <div class="progress-bar progress-bar-striped bg-warning" data-transitiongoal="80"></div>
                        </div>
                        <div class="progress" role="progressbar">
                            <div class="progress-bar progress-bar-striped bg-danger" data-transitiongoal="100"></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-primary text-white">
                        <span>
                            <i class="livicon" data-name="spinner-five" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Vertical Progress bar
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
                    ...
                    <div class="card-body c1">
                        <div class="progress vertical bottom" role="progressbar">
                            <div class="progress-bar bg-info" data-transitiongoal="40"></div>
                        </div>
                        <div class="progress vertical bottom" role="progressbar">
                            <div class="progress-bar bg-success" data-transitiongoal="60"></div>
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-secondary text-white">
                        <span>
                            <i class="livicon" data-name="gears" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Vertical Striped Progress bar
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
                    ...
                    <div class="card-body c1">
                        <div class="progress  vertical bottom" role="progressbar">
                            <div class="progress-bar progress-bar-striped" data-transitiongoal="20">
                            </div>
                        </div>
                        <div class="progress  vertical bottom" role="progressbar">
                            <div class="progress-bar progress-bar-striped bg-info" data-transitiongoal="40"></div>
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-primary text-white">
                        <span>
                            <i class="livicon" data-name="spinner-one" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Animated progressbars
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
                    ...
                    <div class="card-body c2">
                        <div class="progress" role="progressbar">
                            <div class="progress-bar six-sec-ease-in-out" data-transitiongoal="20">
                            </div>
                        </div>
                        <div class="progress" role="progressbar">
                            <div class="progress-bar bg-info six-sec-ease-in-out" data-transitiongoal="40"></div>
                        </div>
                        <div class="progress" role="progressbar">
                            <div class="progress-bar bg-success six-sec-ease-in-out" data-transitiongoal="60"></div>
                        </div>
                        <div class="progress" role="progressbar">
                            <div class="progress-bar bg-warning six-sec-ease-in-out" data-transitiongoal="80"></div>
                        </div>
                        <div class="progress" role="progressbar">
                            <div class="progress-bar bg-danger six-sec-ease-in-out" data-transitiongoal="100"></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-warning text-white">
                        <span>
                            <i class="livicon" data-name="spinner-six" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Inverse Vertical Striped Progress Bar
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
                    ...
                    <div class="card-body c1">
                        <div class="progress vertical" role="progressbar">
                            <div class="progress  vertical wide active text_none">
                                <div class="progress-bar progress-bar-striped bg-primary" data-transitiongoal="20"></div>
                            </div>
                        </div>
                        <div class="progress vertical" role="progressbar">
                        ...
                        <div class="progress vertical" role="progressbar">
                            <div class="progress  vertical wide active">
                                <div class="progress-bar progress-bar-striped bg-success" data-transitiongoal="60"></div>
                            </div>
                        </div>
                        <div class="progress vertical" role="progressbar">
                    ...
                    <div class="card-header bg-danger text-white ">
                        <span>
                            <i class="livicon" data-name="edit" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Typography heading
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
                    ...
                    <div class="card-header bg-secondary text-white">
                        <span>
                            <i class="livicon" data-name="tasks" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Horizontal Description
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
                    ...
                    <div class="card-header bg-primary text-white">
                        <span>
                            <i class="livicon" data-name="align-center" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Unordered List
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-3">
                <div class="card">
                    <div class="card-header bg-success text-white">
                        <span>
                            <i class="livicon" data-name="edit" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Example body text
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
                    ...
                    <div class="card-body">
                        <div class="box-body">
                            <p>Nullam quis risus eget
                                <a href="javascript:void(0)">urna mollis ornare</a> vel eu leo. Cum sociis natoque
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-warning text-white">
                        <span>
                            <i class="livicon" data-name="tasks" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Emphasis Classes
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <div class="card ">
                            <div class="card-header bg-primary text-white">
                                <span>
                                    <i class="livicon" data-name="hand-right" data-size="18" data-c="#fff"
                            ...
                            <div class="panel-footer text-center d-grid">
