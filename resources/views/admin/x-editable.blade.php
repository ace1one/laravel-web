                    ...
                    <div class="card">
                        <div class="card-header buttons bg-info">
                            <div class="row">
                                <div class="col-md-6 btns">
                                    <span>
                                        <i class="livicon" data-name="star-full" data-size="16" data-loop="true"
                                            data-c="#fff" data-hc="white"></i> X-Editable
                                    </span>
                                </div>
                                <div class="col-md-6 col-lg-6 col-12 text-end">
                                    <form method="get" id="frm" class="" action="#">
                                        <label>
                                        ...
                                        <button type="submit"
                                            class="btn btn-raised btn-primary btn-sm btn_refresh">Refresh</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="form-check col-md-12 text-end">
                                    <label>
                                        <input class="custom-checkbox" type="checkbox" id="autoopen">&nbsp; auto-open next
                                        field
                                    </label>
                                    <button id="enable" class="btn btn-success btn-raised btn-sm enable-btn">Enable /
                                        Disable</button>
                                </div>
                                <table id="user" class="table table-bordered table-striped">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" id="firstname" data-type="text" data-pk="1"
                                                    data-placement="top" data-placeholder="Required"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" id="sex" data-type="select" data-pk="1"
                                                    data-value="" data-title="Select sex" class="editable editable-click"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" id="group" data-type="select" data-pk="1"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" id="status" data-type="select" data-pk="1"
                                                    data-value="0" data-source="/status" data-title="Select status"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" id="event" data-type="combodate"
                                                    data-placement="top" data-template="D MMM YYYY  HH:mm"
                                        ...
                                        <tr>
                                            <td>Textarea</td>
                                            <td>
                                                <a href="#" id="comments" data-type="textarea"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" id="state2" data-type="typeaheadjs"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a id="address" data-type="address" data-pk="1"
                                                    ...
                                                    data-original-title="" title=""> <b>Moscow</b> , Lenina st.,
                                                    bld. 12
                                                </a>
                                            </td>
                                        </tr>
