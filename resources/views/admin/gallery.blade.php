                        ...
                        <div class="table-lg">
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a href="#tab_1" class="nav-link active" data-bs-toggle="tab">Basic Gallery</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#tab_2" class="nav-link" data-bs-toggle="tab">Standard Gallery</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#tab_3" class="nav-link" data-bs-toggle="tab">Button Helper</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#tab_4" class="nav-link" data-bs-toggle="tab">Thubnail Helper</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade show active p-3" id="tab_1">
                                        <div class="row">
                                            <div class="col-lg-2 col-md-3 col-6 col-sm-3 p-2">
                                                <a class="fancybox-effects-a" href="{{ asset('img/img_holder/gal/1.jpg') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-md-3 col-6 col-sm-3 p-2">
                                                <a class="fancybox-effects-a" title="Click aside to exit popup">
                                                    <img src="{{ asset('img/img_holder/gal/1.jpg') }}"
                                                        href="{{ asset('img/img_holder/gal/1.jpg') }}"
                                                        class="img-fluid gallery-style" alt="Image">
                                                </a>
