...
<section class="content px-3">
  <div class="row row-cols-lg-2 row-cols-1 ">
            ...
            <div class="col mb-2">
                <div class="card">
                    <div class="card-header bg-white">
                        <span>Grouped stacked Bars</span>
                        <span class="float-end">
                            <i class="fa fa-chevron-up showhide clickable"></i>
                            <i class="fa fa-times removepanel clickable"></i>
                        </span>
            ...
            <div class="col mb-2">
                <div class="card">
                    <div class="card-header bg-white">
                        <span>Bar with Negative values</span>
                        <span class="float-end">
                            <i class="fa fa-chevron-up showhide clickable"></i>
                            <i class="fa fa-times removepanel clickable"></i>
                        </span>
            ...
            <div class="col mb-2">
                <div class="card">
                    <div class="card-header bg-white">
                        <span>Custom DataLabels Bar</span>
                        <span class="float-end">
                            <i class="fa fa-chevron-up showhide clickable"></i>
                            <i class="fa fa-times removepanel clickable"></i>
                        </span>
...
<script src="{{ asset('js/admin/apexcharts_bar.js') }}"></script>
