                ...
                <div class="card ">
                    <div class="card-header bg-warning text-white">
                        <span>
                            <i class="livicon" data-name="shuffle" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Owl Carousel with single image
                        </span>
                    ...
                    <div class="card-body">
                        <div class="owl-carousel owl-theme" id="carousel3">
                            <div class=" item">
                                <img src="{{ asset('img/parallax/photo1.jpg') }}" alt="image1">
                            </div>
                            <div class="item">
                                <img src="{{ asset('img/parallax/photo2.jpg') }}" alt="image2">
                            </div>
                            <div class="item">
                                <img src="{{ asset('img/parallax/photo3.jpg') }}" alt="image3">
                            </div>
                            <div class="item">
                                <img src="{{ asset('img/parallax/photo1.jpg') }}" alt="image4">
                            </div>
                            <div class="item">
                                <img src="{{ asset('img/parallax/photo2.jpg') }}" alt="image5">
                            </div>
                        </div>
                        <!-- End Carousel -->
                    </div>
                    ...
                    <div class="card-header bg-primary text-white">
                        <span>
                            <i class="livicon" data-name="tablet" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Owl Carousel with Autogrow
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
            ...
            <div class="col-md-12 col-lg-12 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-danger text-white ">
                        <span>
                            <i class="livicon" data-name="shuffle" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Owl Carousel with multiple image
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
            ...
            <div class="col-md-12 col-lg-12 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-success text-white">
                        <span>
                            <i class="livicon" data-name="shuffle" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Tabbed Slider Carousel
                        </span>
                        <span class="float-end ">
                            <i class="fa fa-chevron-up clickable"></i>
                        </span>
                            ...
                            <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{ asset('img/parallax/photo1.jpg') }}" class="img-fluid"
                                            alt="image1">
                                        <div class="carousel-caption">
                                            <h3>Headline</h3>
                                            <p>
                                                Lorem ipsum dolor sit amet, consetetur sadipscing elitr<span
                                                    class="hidden-xs"> sed diam nonumy eirmod tempor invidunt ut labore et
                                    ...
                                    <div class="carousel-item">
                                        <img src="{{ asset('img/parallax/photo2.jpg') }}" class="img-fluid"
                                            alt="image1">
                                        <div class="carousel-caption">
                                            <h3>Headline</h3>
                                            <p>
                                    ...
                                    <!-- End Item -->
                                    <div class="carousel-item">
                                        <img src="{{ asset('img/parallax/photo3.jpg') }}" class="img-fluid"
                                            alt="image1">
                                        <div class="carousel-caption">
                                            <h3>Headline</h3>
                                            <p>
                                ...
                                <ul class="nav nav-pills nav-justified">
                                    <li data-bs-target="#myCarousel" data-bs-slide-to="0" class=" nav-item active">
                                        <a href="#" class="nav-link">About</a>
                                    </li>
                                    <li data-bs-target="#myCarousel" data-bs-slide-to="1" class="nav-item">
                                        <a href="#" class="nav-link">Projects</a>
                                    </li>
                                    <li data-bs-target="#myCarousel" data-bs-slide-to="2" class="nav-item">
                                        <a href="#" class="nav-link">Portfolio</a>
                                    </li>
                                    <li data-bs-target="#myCarousel" data-bs-slide-to="3" class="nav-item">
