        ...
        <div class="row">
            <div class="col-12">
                <div class="the-box no-border">
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <div class="mb-3 {{ $errors->first('title', 'has-error') }}">
                        ...
                        <!-- /.col-sm-8 -->
                        <div class="col-sm-4">
                            <div class="mb-3 {{ $errors->first('blog_category_id', 'has-error') }}">
                                ...
                                <span class="form-text">{{ $errors->first('blog_category_id', ':message') }}</span>
                            </div>
                            <div class="mb-3">
                                {!! Form::text('tags', null, [
                                    'class' => 'form-control input-lg',
...
<span class="btn btn-primary btn-file">
                            ...
                            <div class="">
                                ...
                                <a href="{!! URL::to('admin/blog/create') !!}" class="btn btn-danger">@lang('blog/form.discard')</a>
                            </div>
                        </div>
                        <!-- /.col-sm-4 -->
                    </div>
