...
<div class="card-header bg-primary text-white clearfix">
                        ...
                        <div class="float-end">
<a href="{{ URL::to('admin/blog/create') }}" class="btn btn-sm btn-warning text-white"><span
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ URL::to('admin/blog/' . $blog->id) }}"><i class="livicon"
                                                            data-name="info" data-size="18" data-loop="true"
                                                            data-c="#428BCA" data-hc="#428BCA"
                                                            title="@lang('blog/table.view-blog-comment')"></i></a>
                                                    <a href="{{ URL::to('admin/blog/' . $blog->id . '/edit') }}"><i
                                                            class="livicon" data-name="edit" data-size="18" data-loop="true"
                                                            data-c="#428BCA" data-hc="#428BCA"
                                                            title="@lang('blog/table.update-blog')"></i></a>
                                                    <a href="{{ route('admin.blog.confirm-delete', $blog->id) }}"
                                                        data-bs-toggle="modal" data-id="{{ $blog->id }}"
                                                        data-bs-target="#delete_confirm"><i class="livicon"
                                                            data-name="remove-alt" data-size="18" data-loop="true"
                                                            data-c="#f56954" data-hc="#f56954"
