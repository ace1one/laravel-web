                                ...
                                <p class="change_link">
                                    ...
                                    <a href="#toregister">
                                        <button type="button" id="signup"
                                            class="btn btn-success btn-sm float-end">Sign Up
                                        </button>
                                    </a>
                                </p>
<hr>
                                <div class="row">
<div class="col-lg-12 text-center d-grid gap-2 mb-3  ">
...
<div class="d-grid gap-2 mt-2">
                        ...
                        <div id="forgot" class="animate form">
                            <form action="{{ url('admin/forgot-password') }}" autocomplete="on" method="post"
                                ...
                                <h3 class="black_bg my-3">
                                    <img src="{{ asset('img/logo.png') }}" alt="josh logo"><br>Forgot Password
                                </h3>
                                <p class="fontsize14">
