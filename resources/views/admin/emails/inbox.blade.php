...
<tr data-messageid="{{ $email->id }}" @if ($email->status == 1) class="fw-bold" @endif>
                                    <td class="inbox-small-cells width7">
                                        <div class="form-check">
                                            <span>
                                                <input type="checkbox" name="inbox_checkbox" class="mail-checkbox"
                                                    value="{{ $email->id }}">
                                            </span>
                                        </div>
                                    </td>
                                    <td class="read_td"><input type="hidden" value="{{ $email->status }}"
                                            @if ($email->status == 0) class="read" @else class="unread" @endif></td>
...
<td class="text-end width23">
                                        <a
                                            href="{{ URL::to('admin/emails/' . $email->id) }}">{{ $email->created_at->diffForHumans() }}</a>
                                    </td>
                                </tr>
                            @endforeach
...
<div class="pt-1">{!! $emails->render() !!}</div>
                </div>
            </div>
        </div>
    </section>
