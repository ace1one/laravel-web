                    ...
                    <div class="card-body squarebox square_boxs">
                        <div class="col-12 float-start nopadmar">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <span class="widget_circle3 float-end">
                    ...
                    <div class="card-body squarebox square_boxs">
                        <div class="col-12 float-start nopadmar">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <span class="widget_circle4 float-end">
                    ...
                    <div class="card-body squarebox square_boxs">
                        <div class="col-12 float-start nopadmar">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <span class="widget_circle1 float-end">
                    ...
                    <div class="card-body squarebox square_boxs">
                        <div class="col-12 float-start nopadmar">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <span class="widget_circle2 float-end">
                    ...
                    <div class="col-md-12 col-lg-12 col-12">
                        <div class="card card-border main_chart">
                            <div class="card-header bg-white">
                                <span>
                                    <i class="livicon" data-name="barchart" data-size="16" data-loop="true"
                                        data-c="#EF6F6C" data-hc="#EF6F6C"></i> Users Stats
                                </span>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-3 ">
                        <div class="card card-border">
                            <div class="card-header">
                                <h4 class="card-title">
                                    <i class="livicon" data-name="barchart" data-size="16" data-loop="true"
                                        data-c="#67C5DF" data-hc="#67C5DF"></i>
                                    Yearly visitors
                                </h4>
                        ...
                        @foreach ($users as $user)
                            <div class="media d-flex">
                                ...
                                <div class="media-body ms-3">
                                    ...
                                    <p>{{ $user->email }} <span
                                            class="user_create_date float-end">{{ $user->created_at->format('d M') }}
                                        </span>
                                    </p>
                                </div>
                            </div>
                        ...
                        @foreach ($blogs as $blog)
                            <div class="media">
                                ...
                                <div class="media-body ms-3">
                                    ...
                                    <p>category: {{ $blog->category->title }} <span class="user_create_date float-end">by
...
@section('footer_scripts')
    ...
    <script>
        ...
        <!-- prettier-ignore -->
    var demo = new countUp.CountUp("myTargetElement1", 12.52, {!! $pageVisits!!}, 0, 6, options);
        demo.start();
        <!-- prettier-ignore -->
    var demo = new countUp.CountUp("myTargetElement2", 1, {!! $blog_count!!}, 0, 6, options);
        demo.start();
        <!-- prettier-ignore -->
    var demo = new countUp.CountUp("myTargetElement3", 24.02, {{ $visitors }}, 0, 6, options);
        demo.start();
        <!-- prettier-ignore -->
    var demo = new countUp.CountUp("myTargetElement4", 125, {{ $user_count }}, 0, 6, options);
        demo.start();
