            ...
            <div class="col-md-6 col-12 mb-4">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-outline-info me-2">Info
                        </button>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6 text-center">
                                <button type="button" class="btn btn-success rounded-0 me-2">Success</button>
                            </div>
                            <div class="col-6 text-center">
                                <button type="button" class="btn btn-primary rounded-0 me-2">Primary</button>
                            </div>
                        </div>
            ...
            <div class="col-md-6 col-12 mb-4">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6 text-center">
                                <button type="button" class="btn btn-info  me-2 rounded-circle">C</button>
                            </div>
                            <div class="col-6 text-center">
                                <button type="button" class="btn btn-danger  me-2 rounded-circle">D</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-6 col-12 mb-4">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-lg btn-success me-2">Btn-lg</button>
                        <button type="button" class="btn btn-success me-2">Btn</button>
                        <button type="button" class="btn btn-sm btn-success me-2">Btn-sm</button>
                        <button type="button" class="btn btn-xs btn-success me-2">Btn-xs</button>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-12 mb-4">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <div class="flatbuttons_small1 d-grid">
                            <a href="#" class="btn btn-rounded btn-info">Button</a>
                        ...
                        <div class="row mb-3">
                            <div class="col-4 text-center">
                                <button type="button" class="btn btn-labeled btn-success">
                                    <span class="btn-label float-start">
            ...
            <div class=" col-12 ">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <button class="btn  btn-adn me-2 ms-4 mb-3"><i class="fab fa-adn"></i></button>
                        <button class="btn  btn-bitbucket me-2 mb-3"><i class="fab fa-bitbucket"></i></button>
                        <button class="btn  btn-dropbox me-2 mb-3"><i class="fab fa-dropbox"></i></button>
                        <button class="btn  btn-facebook me-2 mb-3"><i class="fab fa-facebook"></i></button>
                        <button class="btn  btn-flickr me-2 mb-3"><i class="fab fa-flickr"></i></button>
                        <button class="btn  btn-foursquare me-2 mb-3"><i class="fab fa-foursquare"></i></button>
                        <button class="btn  btn-github me-2 mb-3"><i class="fab fa-github"></i></button>
                        <button class="btn  btn-google me-2 mb-3"><i class="fab fa-google"></i></button>
                        <button class="btn  btn-instagram me-2 mb-3"><i class="fab fa-instagram"></i></button>
                        <button class="btn  btn-linkedin me-2 mb-3"><i class="fab fa-linkedin"></i></button>
                        <button class="btn  btn-microsoft me-2 mb-3"><i class="fab fa-windows"></i></button>
                        <button class="btn  btn-odnoklassniki me-2 mb-3"><i class="fab fa-odnoklassniki"></i></button>
                        <button class="btn  btn-openid me-2 mb-3"><i class="fab fa-openid"></i></button>
                        <button class="btn  btn-pinterest me-2 mb-3"><i class="fab fa-pinterest"></i></button>
                        <button class="btn  btn-soundcloud me-2 mb-3"><i class="fab fa-soundcloud"></i></button>
                        <button class="btn  btn-tumblr me-2 mb-3"><i class="fab fa-tumblr"></i></button>
                        <button class="btn  btn-twitter me-2 mb-3"><i class="fab fa-twitter"></i></button>
                        <button class="btn  btn-vimeo me-2 mb-3"><i class="fab fa-vimeo-square"></i></button>
                        <button class="btn  btn-vk me-2 mb-3"><i class="fab fa-vk"></i></button>
                        <button class="btn  btn-yahoo me-2 mb-3"><i class="fab fa-yahoo"></i></button>
        ...
        <div class="row mb-4">
            <div class="col-sm-8 col-lg-12 col-12 mb-sm-3">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <button class="btn  btn-outline-adn me-2 mb-3"><i class="fab fa-adn"></i></button>
                        <button class="btn  btn-outline-bitbucket me-2 mb-3"><i class="fab fa-bitbucket"></i></button>
                        <button class="btn  btn-outline-dropbox me-2 mb-3"><i class="fab fa-dropbox"></i></button>
                        <button class="btn  btn-outline-facebook me-2 mb-3"><i class="fab fa-facebook"></i></button>
                        <button class="btn  btn-outline-flickr me-2 mb-3"><i class="fab fa-flickr"></i></button>
                        <button class="btn  btn-outline-foursquare me-2 mb-3"><i class="fab fa-foursquare"></i></button>
                        <button class="btn  btn-outline-github me-2 mb-3"><i class="fab fa-github"></i></button>
                        <button class="btn  btn-outline-google me-2 mb-3"><i class="fab fa-google"></i></button>
                        <button class="btn  btn-outline-instagram me-2 mb-3"><i class="fab fa-instagram"></i></button>
                        <button class="btn  btn-outline-linkedin me-2 mb-3"><i class="fab fa-linkedin"></i></button>
                        <button class="btn  btn-outline-microsoft me-2 mb-3"><i class="fab fa-windows"></i></button>
                        <button class="btn  btn-outline-odnoklassniki me-2 mb-3"><i class="fab fa-odnoklassniki"></i>
                        </button>
                        <button class="btn  btn-outline-openid me-2 mb-3"><i class="fab fa-openid"></i></button>
                        <button class="btn  btn-outline-pinterest me-2 mb-3"><i class="fab fa-pinterest"></i></button>
                        <button class="btn  btn-outline-soundcloud me-2 mb-3"><i class="fab fa-soundcloud"></i></button>
                        <button class="btn  btn-outline-tumblr me-2 mb-3"><i class="fab fa-tumblr"></i></button>
                        <button class="btn  btn-outline-twitter me-2 mb-3"><i class="fab fa-twitter"></i></button>
                        <button class="btn  btn-outline-vimeo me-2 mb-3"><i class="fab fa-vimeo-square"></i></button>
                        <button class="btn  btn-outline-vk me-2 mb-3"><i class="fab fa-vk"></i></button>
                        <button class="btn  btn-outline-yahoo me-2 mb-3"><i class="fab fa-yahoo"></i></button>
                    </div>
