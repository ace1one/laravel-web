                                ...
                                <ul class="timeline">
                                    <li>
                                        <div class="timeline-badge">
                                            <i class="livicon" data-name="users" data-c="#fff" data-hc="#fff"
                                                data-size="18" data-loop="true"></i>
                                        </div>
                                        <div class="timeline-panel d-inline-block">
                                            ...
                                            <div class="timeline-body">
                                                ...
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-primary btn-sm dropdown-toggle"
                                                        ...
                                                        <i class="livicon" data-name="gear" data-size="16"
                                ...
                                <ul class="timeline2">
                                    <li>
                                        <div class="timeline2-badge">
                                            <a>
                                                <i class="fa fa-record invert" rel="tooltip"
                                        ...
                                        <div class="timeline2-panel">
                                            ...
                                            <div class="timeline2-footer">
                                                <a>
                                                    <i class="livicon" data-name="thumbs-up" data-loop="true"
                                                        data-color="#337ab7" data-hovercolor="#23528E"
                                                        data-size="14"></i>
                                                </a>
                                                <a>
                                                    <i class="livicon" data-name="share" data-loop="true"
                                                        data-color="#337ab7" data-hovercolor="#23527c"
                                                        data-size="14"></i>
                                                </a>
                                                <a href="#" class="float-end">Read more</a>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="timeline2-inverted">
                                        <div class="timeline2-badge">
                                            <a>
                                                <i class="fa fa-dot-circle" rel="tooltip"
                                                    title="2 Days ago via Facebook"></i>
                                            </a>
                                        </div>
                                        <div class="timeline2-panel">
                                            <div class="timeline2-heading">
                                                <img data-src="holder.js/580x160/#00BC8C:#fff" class='img-fluid'
                                                    alt="image">
                                            </div>
                                            <div class="timeline2-body">
                                    ...
                                    <li>
                                        <div class="timeline2-badge">
                                            <a>
                                                <i class=" far fa dot-circle" rel="tooltip"
                                                    title="5 Days ago via Facebook"></i>
                                            </a>
                                        </div>
                                        <div class="timeline2-panel">
                                            <div class="timeline2-heading">
                                                <img data-src="holder.js/580x160/#418bca:#fff" class='img-fluid'
                                                    alt="image">
                                            </div>
                                            <div class="timeline2-body">
                                    ...
                                    <li>
                                        ...
                                        <div class="timeline2-panel">
                                            <div class="timeline2-heading">
                                                <img data-src="holder.js/580x160/#5bc0de:#fff" class='img-fluid'
                                                    alt="image">
                                            </div>
                                            <div class="timeline2-body">
...
@section('footer_scripts')
    <script src="{{ asset('js/pages/timeline.js') }}" type="text/javascript"></script>
@stop
