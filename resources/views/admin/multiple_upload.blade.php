...
<button class="btn btn-sm btn-success" data-bs-toggle="modal"
                                    data-bs-target="#multiplefile">Add
                                    New</button>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="multiplefile" tabindex="-1" role="dialog" aria-labelledby="deleteLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row fileupload-buttonbar">
                        <div class="col-lg-12 text-end">
                            ...
                            <button type="submit" class="btn btn-primary start" data-bs-dismiss="modal">
...
@section('footer_scripts')
    ...
    <script src="{{ asset('vendors/blueimp-file-upload/js/jquery.ui.widget.js') }}" type="text/javascript"></script>
    <!-- The Templates plugin is included to render the upload/download listings -->
    <script src="{{ asset('vendors/blueimp-tmpl/js/tmpl.min.js') }}" type="text/javascript"></script>
    <!-- The Load Image plugin is included for the preview images and image resizing functionality -->
    <script src="{{ asset('vendors/blueimp-load-image/js/load-image.all.min.js') }}" type="text/javascript"></script>
    ...
    <script src="{{ asset('vendors/blueimp-file-upload/js/jquery.fileupload.js') }}" type="text/javascript"></script>
    <!-- The File Upload processing plugin -->
    <script src="{{ asset('vendors/blueimp-file-upload/js/jquery.fileupload-process.js') }}" type="text/javascript">
    </script>
    <!-- The File Upload image preview & resize plugin -->
    <script src="{{ asset('vendors/blueimp-file-upload/js/jquery.fileupload-image.js') }}" type="text/javascript"></script>
    ...
    <script src="{{ asset('vendors/blueimp-file-upload/js/jquery.fileupload-ui.js') }}" type="text/javascript"></script>
    ...
    <tr class="template-upload fade">
        ...
        <td>
            {% if (!i && !o.options.autoUpload) { %}
                <button class="btn btn-primary start text-end d-none" disabled>
                    <i class="glyphicon glyphicon-upload"></i>
                    <span>Start</span>
                </button>
            {% } %}
        ...
        $(document).ready(function() {
            ...
            var table = $('#table').DataTable({
                ...
                "createdRow": function(row, data, dataIndex) {
                    ...
                    $('td:eq(3)', row).find('a').attr('data-bs-toggle', 'modal').attr('data-bs-target',
                        '#delete_confirm').attr('data-id', data.id);
                }
            });
