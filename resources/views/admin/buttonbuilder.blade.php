            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    <div class="card-header bg-primary text-white ">
                        <span>
                            <i class="livicon" data-name="vector-square" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i>
                            Button Builder
                        </span>
                            ...
                            <div class="col-md-6">
                                ...
                                <p id="input">
                                    <input id="name" autocomplete="off" class="form-control" type="text"
                                        placeholder="Please enter your button name">
                                </p>
...
<button name="color" type="button" class="btn btn-secondary" value="btn-secondary">Secondary</button>
                                ...
                                <div id="sizes">
                                    <p>
                                        ...
                                        <button class="btn btn-md btn-primary" value="btn-md"
                                            type="button">Default</button>
                                        <button class="btn btn-primary btn-lg" value="btn-lg" type="button">Large</button>
                                    </p>
                                    <p>
                                        <a href="#" class="btn btn-primary btn-block" data-bs-toggle="button">Full
                                            width
                                            button</a>
                                    </p>
                                </div>
...
<button class="btn btn-primary" value="left" type="button">
                                                    <span class="glyphicon glyphicon-arrow-left"></span>
                                                    &nbsp; &nbsp;Left
                                                </button>
<button class="btn btn-primary" value="right" type="button">
                                                    Right &nbsp; &nbsp;
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <ul class="bs-glyphicons">
                                                <li>
<a href="d#" class="btn btn-outline-secondary">
