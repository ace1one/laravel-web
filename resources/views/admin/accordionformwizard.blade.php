                            ...
                            <div class="col-md-9 pd-r">
                                <div id="accordion">
                                    <div class="accordion-item ">
                                        <div class="accordion-header bg-success" id="headingOne">
                                            <h4 class="accordion-title">
                                                <a href="#prerequisites" data-bs-toggle="collapse"
                                                    data-bs-target="#prerequisites" aria-expanded="false"
                                                    aria-controls="prerequisites" class="color_accrd">Install Bootstrap</a>
                                            </h4>
                                        </div>
                                        <div id="prerequisites" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <form id="form-prerequisites">
                                                    ...
                                                    <div class="acc-wizard-step"><button class="btn btn-primary"
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header  bg-info" id="headingTwo">
                                            <h4 class="accordion-title">
                                                <a href="#addwizard" data-bs-toggle="collapse" data-bs-target="#addwizard"
                                                    aria-expanded="false" aria-controls="addwizard"
                                                    class="color_accrd collapsed">Accordion Wizard</a>
                                            </h4>
                                        </div>
                                        <div id="addwizard" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                            ...
                                            <div class="accordion-body">
                                                <form id="form-addwizard">
                                                    ...
                                                    <p>
                                                        ...
                                                        changing the link color), you'll want to make corresponding tweaks
                                                        to
                                    ...
                                    <!-- /.panel.card-default -->
                                    <div class="accordion-item">
                                        <div class="accordion-header  bg-warning" id="headingThree">
                                            <h4 class="accordion-title">
                                                <a href="#adjusthtml" data-bs-toggle="collapse"
                                                    data-bs-target="#adjusthtml" aria-expanded="false"
                                                    aria-controls="adjusthtml" class="color_accrd collapsed">Adjust HTML
                                                    Markup</a>
                                            </h4>
                                        </div>
                                        <div id="adjusthtml" class="accordion-collapse collapse"
                                    ...
                                    <!-- /.panel.card-default -->
                                    <div class="accordion-item ">
                                        <div class="accordion-header bg-danger" id="headingFour">
                                            <h4 class="accordion-title">
                                                <a href="#viewpage" data-bs-toggle="collapse" data-bs-target="#viewpage"
                                                    aria-expanded="false" aria-controls="viewpage"
                                                    class="color_accrd collapsed">Test Your Page</a>
                                            </h4>
                                        </div>
                                        <div id="viewpage" class="accordion-collapse collapse"
                                            aria-labelledby="headingThree" data-bs-parent="#accordion">
                                            <div class="accordion-body">
