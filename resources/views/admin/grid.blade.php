                ...
                <div class="card ">
                    ...
                    <div class="card-body mx-2" id="slim1">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-1 col-sm-2 col-5 text-center col1">
                            ...
                            <div class="col-lg-4 col-md-5 col-sm-4 col-4 text-center col2">
                                <div class="d-lg-block d-md-none d-sm-none">.col-lg-4</div>
                                <div class="d-md-block d-sm-none d-lg-none">.col-md-5</div>
                                <div class="d-sm-block d-md-none d-lg-none">.col-sm-4</div>

                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6 col-3 text-center col3">
                                <div class="d-lg-block d-md-none d-sm-none">.col-lg-4</div>
                        ...
                        <div class="row my-3">
                            <div class="col-sm-2 text-center col1">
                                <div>.col-sm-2</div>
                            </div>
                            <div class="col-sm-4 text-center col2">
                                <div>.col-sm-4</div>
                            </div>
                            <div class="col-sm-6 text-center col3">
                                <div>.col-sm-6</div>
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row my-3">
                            <div class="col-md-1 text-center col1">
                                <div>.col-md-1</div>
                            </div>
                            <div class="col-md-5 text-center col2">
                                <div>.col-md-5</div>
                            </div>
                            <div class="col-md-6 text-center col3">
                                <div>.col-md-6</div>
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row my-3">
                            <div class="col-lg-4 text-center col1">
                                <div>.col-lg-4</div>
                            </div>
                            <div class="col-lg-4 text-center col2">
                                <div>.col-lg-4</div>
                            </div>
                            <div class="col-lg-4 text-center col3">
                                <div>.col-lg-4</div>
                            </div>
                        </div>
                        <!-- end row -->
