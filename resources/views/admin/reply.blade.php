                    ...
                    <table class="table table-striped table-advance">
                        ...
                        <tbody>
                                ...
                                <td colspan="4">
                                    <div class="compose color_reply">
                                        <div class="row">
                                            ...
                                            <input type="text" class="col-9" id="email"
                                                value="zeast@joshadmin.com, " tabindex="1">
                                        </div>
                                        <div class="clear"></div>
                                        <div class="row">
                                            <label class="col-2 hidden-xs" for="sub">Subject:</label>
                                            <input type="text" class="col-9" id="sub" tabindex="1"
                                        ...
                                        <div class="clear"></div>
                                        <div id="cci" class="row d-none">
                                            <label class="col-2 d-none d-sm-block" for="cc">Cc:</label>
                                            <input type="text" class="col-9" id="cc" placeholder="Cc:"
                                                tabindex="1">
                                        </div>
                                        ...
                                        <div class="clear"></div>
                                        <div id="bcci" class="row d-none">
                                            <label class="col-2 d-none d-sm-block" for="bcc">Bcc:</label>
                                            <input type="text" class="col-9" id="bcc" tabindex="1"
                                                placeholder="Bcc:">
                                        </div>
                            ...
                            <tr>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <a href="{{ URL::to('admin/inbox') }}"
                                                        ...
                                                        <span class="livicon" data-n="external-link" data-s="12"
                                                            data-c="white" data-hc="white"></span>
                                                        Send
                                                    </a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="{{ URL::to('admin/inbox') }}"
                                                        ...
                                                        <span class="livicon" data-n="briefcase" data-s="12"
                                                            data-c="white" data-hc="white"></span>
                                                        Draft
                                                    </a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="{{ URL::to('admin/inbox') }}"
                                                        ...
                                                        <span class="livicon" data-n="trash" data-s="12"
                                                            data-c="white" data-hc="white"></span>
                                                        Discard
                                                    </a>
                                                </div>
                                ...
                                <td width="3%"></td>
                                <td width="13%" class="view-message text-end">&nbsp;</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('js/pages/reply.js') }}" type="text/javascript"></script>
