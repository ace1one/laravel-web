...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Heatmap Charts</li>
    </ol>
</section>
<!-- Main content -->
<section class="content px-3">
  <div class="row row-cols-lg-2 row-cols-1 ">
    ...
    <div class="col mb-2">
      <div class="card">
        <div class="card-header bg-white">
          <span>Multiple Colors Flipped</span>
          <span class="float-end">
            <i class="fa fa-chevron-up showhide clickable"></i>
            <i class="fa fa-times removepanel clickable"></i>
          </span>
    ...
    <div class="col mb-2">
      <div class="card">
        <div class="card-header bg-white">
          <span>Multiple Colors for each Series</span>
          <span class="float-end">
            <i class="fa fa-chevron-up showhide clickable"></i>
            <i class="fa fa-times removepanel clickable"></i>
          </span>
...
<script src="{{ asset('js/admin/apexcharts_heatmap.js') }}"></script>
