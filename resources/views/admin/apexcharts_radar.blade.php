...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Radar Charts</li>
    </ol>
</section>
<!-- Main content -->
<section class="content px-3">
  <div class="row row-cols-lg-2 row-cols-1 ">
    ...
    <div class="col mb-2">
      <div class="card">
        <div class="card-header bg-white">
          <span>Radar - Multiple Series</span>
          <span class="float-end">
            <i class="fa fa-chevron-up showhide clickable"></i>
            <i class="fa fa-times removepanel clickable"></i>
          </span>
    ...
    <div class="col mb-2">
      <div class="card">
        <div class="card-header bg-white">
          <span>Radar with Polygon-fill</span>
          <span class="float-end">
            <i class="fa fa-chevron-up showhide clickable"></i>
            <i class="fa fa-times removepanel clickable"></i>
          </span>
...
<script src="{{ asset('js/admin/apexcharts_radar.js') }}"></script>
