            ...
            <div
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <form accept-charset="UTF-8" id="register_here" role="form" action="{{ route('register2') }}"
                            method="post">
                            <!-- CSRF Token -->
                            ...
                            <fieldset>
                                <div class="form-group mb-3 {{ $errors->first('first_name', 'has-error') }}">
                                    <div class=" input-group ">
                                        <span class="input-group-text"><i class="livicon" data-name="user"
                                ...
                                <div class="form-group mb-3  {{ $errors->first('last_name', 'has-error') }}">
                                    <div class="input-group">
                                        <span class="input-group-text">
                                            <i class="livicon" data-name="user" data-size="18" data-c="#000"
                                ...
                                <div class="form-group mb-3  {{ $errors->first('email', 'has-error') }}">
                                    <div class="input-group ">
                                        <span class="input-group-text">
                                            <i class="livicon" data-name="mail" data-size="18" data-c="#000"
                                                data-hc="#000" data-loop="true"></i>
                                        </span>
                                ...
                                <div class="form-group mb-3  {{ $errors->first('email_confirm', 'has-error') }}">
                                    <div class="input-group ">
                                        <span class="input-group-text">
                                            <i class="livicon" data-name="mail" data-size="18" data-c="#000"
                                                data-hc="#000" data-loop="true"></i>
                                ...
                                <div class="form-group mb-3  {{ $errors->first('password_confirm', 'has-error') }}">
                                    <div class="input-group ">
                                        <span class="input-group-text">
                                            <i class="livicon" data-name="key" data-size="18" data-c="#000"
                                                data-hc="#000" data-loop="true"></i>
                                        </span>
                                ...
                                <div class="form-group mb-4">
                                    <label>
                                        ...
                                        <span class="font_size14">I agree for terms & conditions</span>
                                    </label>
                                    <br>
                                </div>
                                <div class="d-grid">
