...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/pages/selectfilter.css') }}" />
                    ...
                    <div class="card-body">
                        <form>
                            <div class="mb-3">
                                ...
                                <select id="tag_list" name="tag_list" class="form-select" width="100%"></select>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <form>
                            <div class="mb-3">
                                ...
                                <select id="multiSelect" name="tag_list[]" class="form-select" width="100%"
                                    multiple></select>
                            </div>
                        </form>
    ...
    <script>
        ...
        function formatRepo(repo) {
            ...
            markup += "<div class='select2-result-repository__statistics'>" +
                "<div class='select2-result-repository__forks'><i class='fa fa-flash'></i> " + repo.forks_count +
                " Forks</div>" +
                "<div class='select2-result-repository__stargazers'><i class='fa fa-star'></i> " + repo.stargazers_count +
                " Stars</div>" +
                "<div class='select2-result-repository__watchers'><i class='fa fa-eye'></i> " + repo.watchers_count +
                " Watchers</div>" +
                "</div>" +
                "</div></div>";
