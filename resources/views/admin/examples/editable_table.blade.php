                    ...
                    <div class="card-body">
                        ...
                        <div id="sample_editable_1_wrapper" class="">
                            <div class="table-responsive">
                                <table
                                    class="table table-striped table-bordered table-hover dataTable no-footer sample_editable"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting_asc" tabindex="0" aria-controls="sample_editable_1"
                                                rowspan="1" colspan="1">Firstname
                                            </th>
                                            <th class="sorting width222" tabindex="0" aria-controls="sample_editable_1"
                                                rowspan="1" colspan="1"
                                                aria-label="
                                                 Last Name
                                            ...
                                            <th class="sorting width124" tabindex="0" aria-controls="sample_editable_1"
                                                rowspan="1" colspan="1"
                                                aria-label="
                                                 Points
                                            : activate to sort column ascending">
                                            ...
                                            <th class="sorting width152" tabindex="0" aria-controls="sample_editable_1"
                                                rowspan="1" colspan="1"
                                                aria-label="
                                                 Notes
                                            : activate to sort column ascending">
                                            ...
                                            <th class="sorting width88" tabindex="0" aria-controls="sample_editable_1"
                                                rowspan="1" colspan="1"
                                                aria-label="
                                                 Edit
                                            : activate to sort column ascending">
                                            ...
                                            <th class="sorting width125" tabindex="0" aria-controls="sample_editable_1"
                                                rowspan="1" colspan="1"
                                                aria-label="
                                                 Delete
                                            : activate to sort column ascending">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-danger" id="delete_item"
        ...
        $(document).ready(function() {
            $(function() {
                ...
                function editRow(table, nRow) {
                    ...
                    jqTds[1].innerHTML =
                        '<input type="text" name="firstname" id="firstname" class="form-control input-small" value="' +
                        firstname + '">';
                    jqTds[2].innerHTML =
                        '<input type="text" name="lastname" id="lastname" class="form-control input-small" value="' +
                        lastname + '">';
                    jqTds[3].innerHTML =
                        '<input type="text" name="points" id="points" class="form-control input-small" value="' +
                        points + '">';
                    jqTds[4].innerHTML =
                        '<input type="text" name="notes" id="notes" class="form-control input-small" value="' +
                        notes + '">';
                ...
                function saveRow(table, nRow) {
                    ...
                    var tableData = 'firstname=' + encodeURIComponent(firstname) + '&lastname=' +
                        encodeURIComponent(lastname) +
                        '&points=' + encodeURIComponent(points) + '&notes=' + encodeURIComponent(notes) +
