...
@section('content')
    ...
    <!-- Main content -->
    <section class="content pe-3 ps-3">
        <div class="row">
            <div class="col-lg-12">
                <div class="card ">
                    <div class="card-header bg-primary text-white">
                        <h4 class="card-title"> <i class="livicon" data-name="users-add" data-size="16" data-loop="true"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    {!! Form::text('title', null, [
                                        'class' => 'form-control',
                                        'placeholder' => trans('blogcategory/form.categoryname'),
                                    ]) !!}
                                </div>
                                <div class="col-sm-4">
