        ...
        <div class="col-lg-12">
            <div class="card ">
                <div class="card-header bg-primary text-white clearfix">
                    <span class="float-start"> <i class="livicon" data-name="users" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($bcategory->blog()->count())
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#blogcategory_exists" data-name="{!! $bcategory->title !!}" class="blogcategory_exists">
                                                    <i class="livicon" data-name="warning-alt" data-size="18"
                                                       data-loop="true" data-c="#f56954" data-hc="#f56954"
                                                       title="@lang('blogcategory/form.blogcategoryexists')"></i>
                                                </a>
                                            @else
                                                <a href="{{ route('admin.blogcategory.confirm-delete', $bcategory->id) }}" data-bs-toggle="modal" data-id="{{ $bcategory->id }}" data-bs-target="#delete_confirm">
