            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-primary text-white">
                        <span>
                            <i class="livicon" data-name="piechart" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="#fff"></i> D3 Basic Pie chart
                        </span>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-primary text-white">
                        <span>
                            <i class="livicon" data-name="piechart" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="#fff"></i> D3 Pie chart with tooltips
                        </span>
                        <span class="float-end">
                            <i class="fa fa-chevron-up showhide clickable"></i>
                            <i class="fa fa-times removepanel clickable"></i>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-primary text-white">
                        <span>
                            <i class="livicon" data-name="piechart" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="#fff"></i> D3 Pie chart with small segment
                        </span>
                        <span class="float-end">
                            <i class="fa fa-chevron-up showhide clickable"></i>
                            <i class="fa fa-times removepanel clickable"></i>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-12 my-3">
                ...
                <div class="card ">
                    <div class="card-header bg-primary text-white">
                        <span>
                            <i class="livicon" data-name="piechart" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="#fff"></i> Interactive Charts
                        </span>
                        <span class="float-end">
                            <i class="fa fa-chevron-up showhide clickable"></i>
                            <i class="fa fa-times removepanel clickable"></i>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-12 my-3">
                ...
                <div class="card ">
                    <div class="card-header bg-primary text-white">
                        <span>
                            <i class="livicon" data-name="piechart" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="#fff"></i> Hidden Labels &amp; Rectangular Pie
                        </span>
                        <span class="float-end">
                            <i class="fa fa-chevron-up showhide clickable"></i>
                            <i class="fa fa-times removepanel clickable"></i>
...
@section('footer_scripts')
    ...
    <script language="javascript" type="text/javascript" src="{{ asset('vendors/flotchart/js/jquery.flot.pie.js') }}">
    </script>
