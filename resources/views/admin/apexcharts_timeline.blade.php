...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Timeline Charts</li>
    </ol>
</section>
<!-- Main content -->
<section class="content px-3">
  <div class="row row-cols-lg-2 row-cols-1 ">
    ...
    <div class="col mb-2">
      <div class="card">
        <div class="card-header bg-white">
          <span>Multiple Series - Group rows</span>
          <span class="float-end">
            <i class="fa fa-chevron-up showhide clickable"></i>
            <i class="fa fa-times removepanel clickable"></i>
          </span>
    ...
    <div class="col mb-2">
      <div class="card">
        <div class="card-header bg-white">
          <span>Dumbbell Chart (Horizontal)</span>
          <span class="float-end">
            <i class="fa fa-chevron-up showhide clickable"></i>
            <i class="fa fa-times removepanel clickable"></i>
          </span>
    ...
    <div class="col mb-2">
      <div class="card">
        <div class="card-header bg-white">
          <span>Advanced (Multiple ranges)</span>
          <span class="float-end">
            <i class="fa fa-chevron-up showhide clickable"></i>
            <i class="fa fa-times removepanel clickable"></i>
          </span>
...
<script src="{{ asset('js/admin/apexcharts_timeline.js') }}"></script>
