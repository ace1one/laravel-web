...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Bubble Charts</li>
    </ol>
</section>
<!-- Main content -->
...
<script src="{{ asset('js/admin/apexcharts_bubble.js') }}"></script>
