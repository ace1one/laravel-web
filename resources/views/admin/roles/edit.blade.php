            ...
            <div class="col-lg-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        @if ($role)
                            {!! Form::model($role, [
                                'url' => URL::to('admin/roles/' . $role->id),
                                'method' => 'put',
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" id="name" name="name" class="form-control"
                                            placeholder=@lang('roles/form.name') value="{!! old('name', $role->name) !!}">
                                    </div>
                                    <div class="col-sm-4">
                            ...
                            <div class="mt-2">
                                <div class="row">
                                    <label for="slug" class="col-sm-2 form-label ">@lang('roles/form.slug')</label>
                                    <div class="col-sm-5">
