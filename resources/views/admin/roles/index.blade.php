            ...
            <div class="col-lg-12">
                <div class="card ">
                    <div class="card-header bg-primary text-white clearfix">
                        <span class=" float-start"><i class="livicon" data-name="users" data-size="16" data-loop="true"
                                data-c="#fff" data-hc="white"></i>
@lang('roles/title.roles')
                        </span>
                        <div class="float-end">
<a href="{{ route('admin.roles.create') }}" class="btn btn-sm btn-warning text-white"><span
