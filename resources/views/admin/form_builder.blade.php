                            ...
                            <div class="col-md-5">
                                <div class="clearfix">
                                    <div class="input-group">
                                        ...
                                        <input id="form-layout-text" class="form-control"
                                            placeholder="Form Layout: 1 column(s)" type="text" readonly>
                                    </div>
                                    <hr>
...
@section('footer_scripts')
    ...
    <script data-main="{{ asset('vendors/bootstrap-form-builder/assets/js/main.js') }}"
        src="https://rawgithub.com/jrburke/requirejs/master/require.js"></script>
    <script>
