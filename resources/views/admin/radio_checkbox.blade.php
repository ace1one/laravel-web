                    ...
                    <div class="card-body">
                        <div class="box-body">
                            <div class="form-check mb-3">
                                <label>
                                    <input type="checkbox" class="flat-red form-check-input" checked />
                                </label>
                                <label>
                                    <input type="checkbox" class="flat-red form-check-input" />
                                </label>
                                <label>
                                    <input type="checkbox" class="flat-red form-check-input" disabled />
                                </label>
                            ...
                            <div class="form-check mb-3">
                                <label>
                                    <input type="checkbox" class="square form-check-input" checked />
                                </label>
                                <label>
                                    <input type="checkbox" class="square form-check-input" />
                                </label>
                                <label>
                                    <input type="checkbox" class="square form-check-input" disabled />
                                </label>
                                <label>Square skin checkbox</label>
                            </div>
                            <div class="form-check mb-3">
                                <label>
                                    <input type="checkbox" class="minimal-blue form-check-input" checked />
                                </label>
                                <label>
                                    <input type="checkbox" class="minimal-blue form-check-input" />
                                </label>
                                <label>
                                    <input type="checkbox" class="minimal-blue form-check-input" disabled />
                                </label>
                                <label>Minimal skin checkbox</label>
                            </div>
                            <div class="form-check mb-3">
                                <label>
                                    <input type="checkbox" class="polaris form-check-input" checked />
                                </label>
                                <label>
                                    <input type="checkbox" class="polaris form-check-input" />
                                </label>
                                <label>
                                    <input type="checkbox" class="polaris form-check-input" disabled />
                                </label>
                            ...
                            <div class="form-check">
                                ...
                                <input type="checkbox" class="line mar-t5 form-check-input" checked />
                                <label>Checkbox1
                                </label>
                                <input type="checkbox" class="line mar-t5 form-check-input" />
                                <label>Checkbox2
                                </label>
                                <input type="checkbox" class="line mar-t5 form-check-input" disabled />
                                <label>Disable
                                </label>
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <div class="box-body">
                            ...
                            <div class="form-check mb-3">
                                <label>
                                    <input type="radio" name="r3" class="flat-red form-check-input" checked />
                                </label>
                                <label>
                                    <input type="radio" name="r3" class="flat-red form-check-input" />
                                </label>
                                <label>
                                    <input type="radio" name="r3" class="flat-red form-check-input" disabled />
                                </label>
                            ...
                            <div class="form-check mb-3">
                                <label>
                                    <input type="radio" name="r1" class="square form-check-input" checked />
                                </label>
                                <label>
                                    <input type="radio" name="r1" class="square form-check-input" />
                                </label>
                                <label>
                                    <input type="radio" name="r1" class="square form-check-input" disabled />
                                </label>
                                <label>Square skin radio</label>
                            </div>
                            <div class="form-check mb-3">
                                <label>
                                    <input type="radio" name="r4" class="minimal-blue form-check-input" checked />
                                </label>
                                <label>
                                    <input type="radio" name="r4" class="minimal-blue form-check-input" />
                                </label>
                                <label>
                                    <input type="radio" name="r4" class="minimal-blue form-check-input"
                                        disabled />
                            ...
                            <div class="form-check mb-3">
                                <label>
                                    <input type="radio" name="r5" class="polaris form-check-input" checked />
                                </label>
                                <label>
                                    <input type="radio" name="r5" class="polaris form-check-input" />
                                </label>
                                <label>
                                    <input type="radio" name="r5" class="polaris form-check-input" disabled />
                                </label>
                            ...
                            <div class="form-check">
                                ...
                                <input type="radio" name="r2" class="line form-check-input" checked />
                                <label>Radio button1
                                </label>
                                <input type="radio" name="r2" class="line form-check-input" />
                                <label>Radio button2
                                </label>
                                <input type="radio" name="r2" class="line form-check-input" disabled />
                                <label>Disabled
                                </label>
                        ...
                        <div class="box-body">
                            <div class="">
                                ...
                                <div class="form-check abc-checkbox">
                                    <input class="form-check-input" type="checkbox" id="singleCheckbox1" value="option1"
                                ...
                                <div class="form-check abc-checkbox abc-checkbox-primary">
                                    <input class="form-check-input" type="checkbox" id="singleCheckbox2" value="option2"
                                        checked aria-label="Single checkbox Two">
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check abc-radio abc-radio-success">
                            <input class="form-check-input" type="radio" id="singleRadio1" value="option1"
                                name="radioSingle1" aria-label="Single radio One">
                            <label class="form-check-label" for="singleRadio1"></label>
                        </div>
                        <div class="form-check abc-radio abc-radio-success">
                            <input class="form-check-input" type="radio" id="singleRadio2" value="option2"
                        ...
                        <div class="form-check abc-radio abc-radio-info">
                            <input class="form-check-input" type="radio" name="radio2" id="radio6"
                                value="option2" checked>
                        ...
                        <div class="form-check abc-radio abc-radio-warning">
                            <input class="form-check-input" type="radio" name="radio2" id="radio7"
                                value="option2" checked>
