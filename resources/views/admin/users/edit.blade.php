                    ...
                    <div class="card-body">
                        ...
                        <div id="rootwizard">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item"><a href="#tab2" data-bs-toggle="tab" class="nav-link ms-2">Bio</a>
                                </li>
                                <li class="nav-item"><a href="#tab3" data-bs-toggle="tab"
                                        class="nav-link ms-2">Address</a>
                                </li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane " id="tab1">
                                    ...
                                    <div class="form-group mb-3 {{ $errors->first('last_name', 'has-error') }}">
                                        <div class="row"> <label for="last_name" class="col-sm-2 form-label">Last Name
                                                *</label>
                                            <div class="col-sm-10">
                                    ...
                                    <div class="form-group mb-3 {{ $errors->first('password_confirm', 'has-error') }}">
                                        <div class="row">
                                            <label for="password_confirm" class="col-sm-2 form-label">Confirm Password
                                                *</label>
                                            <div class="col-sm-10">
                                ...
                                <div class="tab-pane" id="tab2" disabled="disabled">
                                    <h2 class="hidden">&nbsp;</h2>
                                    <div class="form-group mb-2 {{ $errors->first('dob', 'has-error') }}">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    ...
                                                    <div>
                                                        ...
                                                        <a href="#"
                                                            class="btn btn-primary fileinput-exists blackcol"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <label for="bio" class="col-sm-2 form-label">Bio <small>(brief intro)
                                                    *</small></label>
                                            <div class="col-sm-10">
                                ...
                                <div class="tab-pane" id="tab3" disabled="disabled">
                                    <div class="form-group mb-2 {{ $errors->first('gender', 'has-error') }}">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-select" title="Select Gender..." name="gender">
                                                    <option value="">Select</option>
                                                    <option value="male"
                                                        @if ($user->gender === 'male') selected="selected" @endif>Male
                                                    </option>
                                                    <option value="female"
                                                        @if ($user->gender === 'female') selected="selected" @endif>Female
                                                    </option>
                                                    <option value="other"
                                                        @if ($user->gender === 'other') selected="selected" @endif>Other
                                                    </option>
                                    ...
                                    <div class="form-group mb-2 {{ $errors->first('country', 'has-error') }}">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::select('country', $countries, old('country', $user->country), [
                                                    'class' => 'country_field
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            form-control',
                                                ]) !!}
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="state" name="user_state" type="text"
                                                    class="form-control" value="{!! old('user_state', $user->user_state) !!}" />
                                            </div>
                                ...
                                <div class="tab-pane" id="tab4" disabled="disabled">
                                                ...
                                                <select class="form-control required" title="Select role..."
                                                    ...
                                                    @foreach ($roles as $role)
                                                        <option value="{!! $role->id !!}"
                                                            ...
                                                            @if ($user->id == 1 && $role->id >= 2) disabled @endif
                                                            @if ($user->id == 2 && $role->id != 2) disabled @endif>
                                                            {{ $role->name }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <label for="activate" class="col-sm-2 form-label"> Activate User *</label>
                                            <div class="col-sm-10">
