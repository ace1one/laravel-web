                    ...
                    <table class="table table-striped table-advance table-hover" id="inbox-check">
                                ...
                                <th colspan="6">
                                    <div class="row">
                                        <div class="col-md-9 col-lg-9 col-12">
                                            ...
                                            <div
                                                class="btn-group ms-2 table-bordered paddingrightleft_10 paddingtopbottom_5px">
                                                <i class="livicon" data-n="refresh" data-s="23"></i>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-3 col-12 float-end">
                                            <div class="float-end">
                                                <ul class="pagination ">
                                                    <li class="">
                                                        <a href="#">&laquo;</a>
                        ...
                        <tbody>
                            <tr data-messageid="1" class="unread">
                                ...
                                <td width="13%" class="view-message text-end">
...
@section('footer_scripts')
    ...
    <script src="{{ asset('js/pages/trash.js') }}" type="text/javascript"></script>
