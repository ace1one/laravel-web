...
@section('content')
    ...
    <section class="content px-3">
        <div class="row">
            <div class="col-md-12">
                <div class="mb-2" id="nestable_list_menu">
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-3">
                    ...
                    <div class="card-header bg-primary text-white">
                        <span>
                            <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Nestable List 1
                        </span>
                    </div>
                    <div class="card-body ">
                ...
                <div class="card ">
                    <div class="card-header bg-info text-white">
                        <span>
                            <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Nestable List 3
                        </span>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-6 col-sm-6 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-success text-white">
                        <span>
                            <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Nestable List 2
                        </span>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-danger text-white ">
                        <span>
                            <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="white"></i> Connected Sortable Lists
                        </span>
                    </div>
                    <div class="card-body">
                        <div class="row">
...
@section('footer_scripts')
    ...
    <script src="{{ asset('vendors/html5sortable/js/html5sortable.js') }}"></script>
