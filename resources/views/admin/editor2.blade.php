...
@section('header_styles')
    ...
    <link href="{{ asset('vendors/bootstrap3-wysihtml5-bower/css/bootstrap3-wysihtml5.min.css') }}" rel="stylesheet"
        media="screen" />
    <link href="{{ asset('vendors/summernote/css/summernote-lite.css') }}" rel="stylesheet" type="text/css">
                    ...
                    <div class="card-body panel_bgcolor">
                        <div class='box well well-sm'>
                            <div class='box-header'>
                                ...
                                <div class="float-end box-tools"></div>
                                <div class='box-body box_content'>
                                    <form>
                                        <textarea id="bootstrap-editor2" class="textarea editor-cls" placeholder="Place some text here"></textarea>
                                    </form>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card my-3">
                    <div class="card-header bg-primary text-white">
                        <div class="text-white bootstrap-admin-box-title editor-clr">
                            <span><i class="livicon" data-name="tag" data-size="16" data-loop="true" data-c="#fff"
                                    data-hc="white"></i>
                                SummerNote</span>
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="card my-3">
                    <div class="card-header bg-success text-white">
                        <div class="text-white bootstrap-admin-box-title editor-clr">
                            <span><i class="livicon" data-name="thermo-down" data-size="16" data-loop="true" data-c="#fff"
                                    data-hc="white"></i>
                                Flip Editor</span>
                        </div>
                    </div>
...
@section('footer_scripts')
    ...
    <script src="{{ asset('vendors/bootstrap3-wysihtml5-bower/js/bootstrap3-wysihtml5.min.js') }}" type="text/javascript">
    </script>
    <script src="{{ asset('vendors/summernote/js/summernote-lite.js') }}" type="text/javascript"></script>
