                    ...
                    <table class="table table-striped table-advance table-hover" id="inbox-check">
                                ...
                                <th colspan="6">
                                    <div class="row">
                                        <div class="col-md-8 col-lg-9 col-12">
                                            <div
                                                class="btn-group float-start table-bordered paddingtopbottom_5px paddingrightleft_10">
                                            ...
                                            <div
                                                class="btn-group float-start table-bordered paddingtopbottom_5px paddingrightleft_10 margin_left">
                        ...
                        <tbody>
                            <tr data-messageid="1" class="unread">
                                ...
                                <td class="view-message  d-none d-sm-block width22">
                                ...
                                <td class="view-message width56">
                                    <a href="{{ URL::to('admin/view_mail') }}">Fwd: Make changes as needed</a>
                                </td>
                                <td class="view-message inbox-small-cells width3">
                                    <a href="{{ URL::to('admin/view_mail') }}">
                                        <i class="fa fa-paperclip"></i>
                                    </a>
                                </td>
                                <td class="view-message text-end width13">
                            ...
                            <tr data-messageid="2" class="unread">
                                ...
                                <td class="view-message  d-none d-sm-block">
                                    <a href="{{ URL::to('admin/view_mail') }}">
                                        <img data-src="holder.js/25x25/#000:#fff"
                                            class="rounded-circle img-fuid float-start" alt="Image">Marin</a>
                                </td>
