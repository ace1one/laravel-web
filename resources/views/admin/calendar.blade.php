            ...
            <div class="col-md-3 col-lg-3 col-12">
                <div class="box">
                    <div class="box-title">
                        ...
                        <div class="float-end box-toolbar">
                            <a href="#" class="btn btn-link btn-xs" data-bs-toggle="modal" data-bs-target="#myModal">
                    ...
                    <div class="box-body">
                        <div id='external-events'>
                            <div class='external-event palette-warning fc-event'>Team Out <i class="fa fa-times event-clear"
                    ...
                    <div class="box-footer d-grid">
                        <a href="#" class="btn btn-success createevent_btn" data-bs-toggle="modal"
                            data-bs-target="#myModal">Create event</a>
                    </div>
                </div>
                <!-- /.box -->
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-btn">
                                <button type="button" id="color-chooser-btn"
                                    class="color-chooser btn btn-info dropdown-toggle" data-bs-toggle="dropdown">
                                    Type
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger float-end reset" data-bs-dismiss="modal">
                            Close
        ...
        <div class="modal fade" id="evt_modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success  me-auto text_save" data-bs-dismiss="modal">
                            Update
                        </button>
