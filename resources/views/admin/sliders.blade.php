                    ...
                    <div class="card-body" id="slim1">
                        ...
                        <form role="form" class="form-horizontal form-bordered">
                            <div class="form-body">
                                <div class="mb-3">
                                    <div class="row">
                                        <label class="col-md-2 fw-light form-label">Basic Slider</label>
                                        <div class="col-md-10">
                                            <input id="example_1" class="form-control" type="text" name=""
                                                value="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <div class="row">
                                        <label class="col-md-2 fw-light form-label">Money Range</label>
                                        <div class="col-md-10">
                                ...
                                <div class="mb-3">
                                    <div class="row">
                                        <label class="col-md-2 fw-light form-label">Gold Range</label>
                                        <div class="col-md-10">
                                ...
                                <div class="mb-3">
                                    <div class="row">
                                        <label class="col-md-2 fw-light  form-label">Temperature Slider</label>
                                        <div class="col-md-10">
                                ...
                                <div class="mb-3">
                                    <div class="row">
                                        <label class="col-md-2 fw-light form-label">Month Slider</label>
                                        <div class="col-md-10">
                                    ...
                                    <div class="mb-3">
                                        <div class="row">
                                            <label class="col-md-2 fw-light form-label">Year Range</label>
                                            <div class="col-md-10">
                                ...
                                <div class="mb-3">
                                    <div class="row">
                                        <label class="col-md-2 fw-light form-label">Year Slider</label>
                                        <div class="col-md-10">
                                ...
                                <div class="mb-3 last">
                                    <div class="row">
                                        <label class="col-md-2 fw-light form-label">Ion range Slider</label>
                                        <div class="col-md-10">
                            ...
                            <div class="col-12">
                                <form role="form" class="form-horizontal form-bordered">
                                    <div class="form-body">
                                        <div class="mb-3">
                                            <div class="row my-2">
                                                <label class="col-md-2 fw-light  form-label">Basic
                                                    Slider</label>
                                                <div class="col-md-10">
                                        ...
                                        <div class="mb-3">
                                            <div class="row my-5">
                                                <label class="col-md-2 fw-light  form-label">Money
                                                    Range</label>
                                                <div class="col-md-10"> <b class="margin-right15">€ 10</b>
                                                    <input id="ex2" type="text" class="span2" value=""
                                                        data-slider-min="10" data-slider-max="1000"
                                                        data-slider-id='ex2Slider' data-slider-step="5"
                                        ...
                                        <div class="mb-3">
                                            <div class="row my-3">
                                                <label class="col-md-2 fw-light  form-label">Color
                                                    Range</label>
                                                <div class="col-md-10">
                                                    <div class="well">
                                                        <p>
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                <div class="row my-2">
                                                    <label class="col-md-2 fw-light  form-label">Vertical
                                                        Slider</label>
                                                    <div class="col-md-10">
                                                        <input id="ex4" type="text" data-slider-min="-5"
                                                            data-slider-max="20" data-slider-step="1"
                                                            data-slider-id='ex3Slider' data-slider-value="-3"
                                            ...
                                            <div class=" destroy-margt">
                                                <div class="row my-5">
                                                    <label class="col-md-2 fw-light form-label">Destroy</label>
                                                    <div class="col-md-10">
                                                        <input id="ex5" type="text" data-slider-min="-5"
                                                            data-slider-id='ex4Slider' data-slider-max="20"
                                                            data-slider-step="1" data-slider-value="0" />
                                                        <button type="button" id="destroyEx5Slider"
                                                            class='btn btn-danger'>Click to Destroy</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <div class="row my-5">
                                                    <label class="col-md-2 fw-light  form-label">Current
                                                        Range</label>
                                                    <div class="col-md-10">
                                                        <input id="bootstrap_slider6" type="text"
                                                            class="form-control slider-handle min-slider-handle round"
                                                            data-slider-id='bootstrap_slider6' data-slider-min="-5"
                                                            data-slider-max="20" data-slider-step="1"
                                                            data-slider-value="3" />
                                            ...
                                            <div class="mb-3">
                                                <div class="row my-5">
                                                    <label class="col-md-2 fw-light  form-label">Enable
                                                        Slider</label>
                                                    <div class="col-md-10">
                                                        <input id="ex7"
                                                            ...
                                                            data-slider-id='ex5Slider' data-slider-id="RED" />
                                            ...
                                            <div class=" slider_tooltip">
                                                <div class="row my-5">
                                                    <label class="col-md-2 fw-light  form-label">Tooltip
                                                        Slider</label>
                                                    <div class="col-md-10">
                                                        <input id="ex8"
                                                            ...
                                                            data-slider-max="20" data-slider-step="1"
                                                            data-slider-value="14" data-slider-tooltip="show" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <div class="row my-5">
                                                    <label class="col-md-2 fw-light  form-label">Precision
                                                        Slider</label>
                                                    <div class="col-md-10">
                                                        <input id="ex9" class="slider form-control"
                                                            data-slider-precision="2.5" data-slider-step="0.01"
                                                            data-slider-value="8.115" data-slider-id='ex9Slider'
                                                            type="text" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="row my-5">
                                                    <label class="col-md-2 fw-light  form-label">Marks and
                                                        Lables</label>
                                                    <div class="col-md-10">
                                            ...
                                            <div class="mb-3">
                                                <div class="row my-5">
                                                    <label class="col-md-2 fw-light  form-label">Reset
                                                        Slider</label>
                                                    <div class="col-md-10">
                                                        <div class="well">
                                                            <input id="ex12" data-slider-id="ex26Slider"
                                                                type="text"
                                                                class="slider-handle min-slider-handle round"data-slider-min="0"
                                                                data-slider-max="20" data-slider-step="1"
                                                                data-slider-value="10" />
                                                            <button id="ex12_Refresh"
                                            ...
                                            <div class=" last">
                                                <div class="row my-5">
                                                    <label class="col-md-2 fw-light  form-label">Step
                                                        Slider</label>
                                                    <div class="col-md-10">
                                                        <input id="ex13" type="text" data-slider-handle="custom"
                                                            data-slider-step="20000" data-slider-min="0"
