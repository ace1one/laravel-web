...
@section('content')
    ...
    <section class="content px-3">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 col-12 my-3">
                <div class="card ">
                    <div class="card-header bg-primary text-white">
                        <span>
                            <i class="livicon" data-name="rocket" data-loop="true" data-color="#fff" data-hovercolor="white"
                                data-size="16"></i> Modals
                        </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal1" data-whatever="@mdo">Form in Modal</button>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 ">
                                ...
                                <br>
                                <button class="btn btn-raised btn-primary " data-bs-toggle="modal"
                            ...
                            <div class="col-md-3">
                                ...
                                <button class="btn btn-raised btn-info " data-bs-toggle="modal"
                                    data-bs-target="#modal-8">3D
                                    Expand Open
                                </button>
                                <button class="btn btn-raised btn-info " data-bs-toggle="modal"
                                    data-bs-target="#modal-9">3D
                                    Big Entrance
                                </button>
                                <button class="btn btn-raised btn-info " data-bs-toggle="modal"
                                    data-bs-target="#modal-10">3D
                                    Expand Up
                                </button>
                                <button class="btn btn-raised btn-info " data-bs-toggle="modal"
                                    data-bs-target="#modal-14">3D
                                    Bounce
                                </button>
                                <button class="btn btn-raised btn-info " data-bs-toggle="modal"
                                    data-bs-target="#modal-15">3D
                                    Pulse
                                </button>
                                <button class="btn btn-raised btn-info " data-bs-toggle="modal"
                                    data-bs-target="#modal-13">3D
                                    Tossing
                                </button>
                            </div>
                            <div class="col-md-3">
                                ...
                                <br>
                                <button class="btn btn-raised btn-warning " data-bs-toggle="modal"
                            ...
                            <div class="col-md-3">
                                ...
                                <button class="btn btn-raised btn-primary md-trigger" data-bs-toggle="modal"
                                    data-bs-target="#modal-16">Primary
                                </button>
                                <button class="btn btn-raised btn-info md-trigger" data-bs-toggle="modal"
                                    data-bs-target="#modal-17">Info
                                </button>
                                <button class="btn btn-raised btn-success md-trigger" data-bs-toggle="modal"
                                    data-bs-target="#modal-18">Success
                                </button>
                                <button class="btn btn-raised btn-danger md-trigger" data-bs-toggle="modal"
                                    data-bs-target="#modal-21">Danger
                                </button>
                                <button class="btn btn-raised btn-secondary md-trigger" data-bs-toggle="modal"
                                    data-bs-target="#modal-19">Default
                                </button>
                                <button class="btn btn-raised btn-warning md-trigger" data-bs-toggle="modal"
                                    data-bs-target="#modal-20">Warning
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <!--moddal dialog -->
        <div class="modal fade modal-fadeIn" id="modal-1" aria-labelledby="modalLabelfade" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                    ...
                    <div class="modal-footer">
                        <button class="btn  btn-primary" data-bs-dismiss="modal">Close me!</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade slideRight" id="modal-2" aria-labelledby="modalLabelslide">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
        ...
        <div class="modal fade slideDown" id="modal-3" aria-labelledby="modalLabelslidebottom">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
        ...
        <div class="modal fade pullDown" id="modal-4" aria-labelledby="modalLabelnews">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-warning text-white">
                    ...
                    <div class="modal-footer">
                        <button class="btn  btn-warning" data-bs-dismiss="modal">Close me!</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade floating" id="modal-5" aria-labelledby="modalLabelfall">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-warning text-white">
        ...
        <div class="modal fade stretchLeft" id="modal-6" aria-labelledby="modalLabelsidefall1">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-warning text-white">
        ...
        <div class="modal fade pullUp" id="modal-7" aria-labelledby="modalLabelsticky">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-warning text-white">
        ...
        <div class="modal fade expandOpen" id="modal-8" aria-labelledby="my3dlabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-info" data-bs-dismiss="modal">Close Me!</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade bigEntrance" id="modal-9" aria-labelledby="Modallabel3dflip">
            <div class="modal-dialog" role="document">
                <div class="modal-content ">
                    <div class="modal-header bg-info text-white ">
        ...
        <div class="modal fade slideExpandUp" id="modal-10" aria-labelledby="Modallabel3dsign">
            <div class="modal-dialog" role="document">
                <div class="modal-content ">
                    <div class="modal-header bg-info text-white">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-info" data-bs-dismiss="modal">Close me!</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade stretchRight" id="modal-11" aria-labelledby="modalLabelsidefall2">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-warning text-white">
        ...
        <div class="modal fade tossing" id="modal-13" aria-labelledby="Modallabel3dslit">
            <div class="modal-dialog" role="document">
                <div class="modal-content ">
                    <div class="modal-header bg-info text-white">
        ...
        <div class="modal fade bounce" id="modal-14" aria-labelledby="Modallabel3drotate">
            <div class="modal-dialog" role="document">
                <div class="modal-content ">
                    <div class="modal-header bg-info text-white">
        ...
        <div class="modal fade pulse" id="modal-15" aria-labelledby="Modallabel3drotateinleft">
            <div class="modal-dialog" role="document">
                <div class="modal-content ">
                    <div class="modal-header bg-info text-white">
        ...
        <div class="modal fade" id="modal-16" aria-labelledby="modalLabelprimary">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
        ...
        <div class="modal fade" id="modal-17" aria-labelledby="modalLabelinfo">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
        ...
        <div class="modal fade" id="modal-18" aria-labelledby="modalLabelsuccess">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-success text-white">
                    ...
                    <div class="modal-footer">
                        <button class="btn  btn-success" data-bs-dismiss="modal">Close me!</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="modal-19" aria-labelledby="modalLabeldefault">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn  btn-secondary" data-bs-dismiss="modal">Close me!</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="modal-20" aria-labelledby="modalLabelwarn">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-warning text-white">
        ...
        <div class="modal fade" id="modal-21" aria-labelledby="modalLabeldanger">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn  btn-danger" data-bs-dismiss="modal">Close me!</button>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                <tbody>
                                    <tr>
                                        <td>Responsive</td>
                                        <td>
                                            <a class="btn btn-raised btn-success btn-large" data-bs-toggle="modal"
                                    ...
                                    <tr>
                                        <td>Stackable</td>
                                        <td>
                                            <a class="btn btn-raised btn-primary btn-large" data-bs-toggle="modal"
                                    ...
                                    <tr>
                                        <td>Ajax</td>
                                        <td>
                                            <a class="btn btn-raised btn-warning btn-large" data-bs-toggle="modal"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-raised btn-danger btn-large" data-bs-toggle="modal"
                                    ...
                                    <tr>
                                        <td>Full Width</td>
                                        <td>
                                            <a class="btn btn-raised btn-info btn-large" data-bs-toggle="modal"
                                    ...
                                    <tr>
                                        <td>Long Modals</td>
                                        <td>
                                            <a class="btn btn-raised btn-secondary btn-large" data-bs-toggle="modal"
        ...
        <div class="extended_modals">
            <div class="modal fade in" id="responsive" tabindex="-1" aria-hidden="false">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title me-auto">Responsive</h4>
            ...
            <!-- END modal-->
            <!--- stack1 model -->
            <div class="modal fade bs-example-modal-sm in" id="stack1" tabindex="-1" aria-hidden="false">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <a class="btn btn-success" data-bs-toggle="modal" href="#stack2">Launch modal</a>
                        </div>
                        <div class="modal-footer">
                            <button type="button" data-bs-dismiss="modal" class="btn btn-secondary">Close</button>
            ...
            <!-- stack2 modal-->
            <div class="modal fade bs-example-modal-md in" id="stack2" tabindex="-1" aria-hidden="false">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <a class="btn btn-success" data-bs-toggle="modal" href="#stack3">Launch modal</a>
                        </div>
                        <div class="modal-footer">
                            <button type="button" data-bs-dismiss="modal" class="btn btn-secondary">Close</button>
                            <button type="button" class="btn btn-primary">Ok</button>
            ...
            <!-- END modal-->
            <!-- stack3 modal-->
            <div class="modal fade in" id="stack3" tabindex="-1" aria-hidden="false">
            ...
            <!-- ajax-modal modal-->
            <div class="modal fade in" id="ajax-modal" tabindex="-1" aria-hidden="false">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a href="#tab1" data-bs-toggle="tab" class="nav-link active">Tab 1</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#tab2" data-bs-toggle="tab" class="nav-link">Tab 2</a>
                                </li>
                            </ul>
            ...
            <!-- static modal-->
            <div class="modal fade in" id="static" tabindex="-1" aria-hidden="false">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" data-bs-dismiss="modal" class="btn btn-primary">Continue Task</button>
                        </div>
                    </div>
                </div>
            </div>
            <!-- END modal-->
            <!-- fullwidth modal-->
            <div class="modal fade in" id="full-width" tabindex="-1" aria-hidden="false">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            <!-- END modal-->
            <!-- long modal-->
            <div class="modal fade in" id="long" tabindex="-1" aria-hidden="false">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
...
@section('footer_scripts')
    <script src="{{ asset('js/pages/modals.js') }}"></script>
@stop
