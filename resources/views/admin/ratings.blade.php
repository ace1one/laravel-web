                                    ...
                                    <div class="pad10">
                                        <form>
                                            <fieldset class="starability-grow">
                                                ...
                                                <input type="radio" id="growing-rate1" name="rating"
                                                    value="1" />
                                                <label for="growing-rate1" title="Terrible"></label>
                                                <input type="radio" id="growing-rate2" name="rating"
                                                    value="2" />
                                                <label for="growing-rate2" title="Not good"></label>
                                                <input type="radio" id="growing-rate3" name="rating"
                                                    value="3" />
                                                <label for="growing-rate3" title="Average"></label>
                                                <input type="radio" id="growing-rate4" name="rating"
                                                    value="4" />
                                                <label for="growing-rate4" title="Very good"></label>
                                                <input type="radio" id="growing-rate5" name="rating"
                                                    value="5" />
                                    ...
                                    <div class="pad10">
                                        <form>
                                            <fieldset class="starability-checkmark">
                                                ...
                                                <input type="radio" id="checkmark-rate1" name="rating"
                                                    value="1" />
                                                <label for="checkmark-rate1" title="Terrible"></label>
                                                <input type="radio" id="checkmark-rate2" name="rating"
                                                    value="2" />
                                                <label for="checkmark-rate2" title="Not good"></label>
                                                <input type="radio" id="checkmark-rate3" name="rating"
                                                    value="3" />
                                                <label for="checkmark-rate3" title="Average"></label>
                                                <input type="radio" id="checkmark-rate4" name="rating"
                                                    value="4" />
                                                <label for="checkmark-rate4" title="Very good"></label>
                                                <input type="radio" id="checkmark-rate5" name="rating"
                                                    value="5" />
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="is-empty">
                                <label class="form-label" for="your_review">Your Review</label>
                                <textarea id="your_review" name="example-textarea-input" class="form-control resize_vertical h100"></textarea>
                            </div>
                            <div class="col-md-12">
                                <div class="pad10">
                                    <form>
                                        <fieldset class="starability-growRotate">
                                            ...
                                            <input type="radio" id="growing-rotating-ratem5" name="rating"
                                                value="1" />
                                            <label for="growing-rotating-ratem5" title="Terrible"></label>
                                            <input type="radio" id="growing-rotating-ratem4" name="rating"
                                                value="2" />
                                            <label for="growing-rotating-ratem4" title="Not good"></label>
                                            <input type="radio" id="growing-rotating-ratem3" name="rating"
                                                value="3" />
                                            <label for="growing-rotating-ratem3" title="Average"></label>
                                            <input type="radio" id="growing-rotating-ratem2" name="rating"
                                                value="4" />
                                            <label for="growing-rotating-ratem2" title="Very good"></label>
                                            <input type="radio" id="growing-rotating-ratem1" name="rating"
                                                value="5" />
                            ...
                            <button type="submit" class="btn btn-primary float-end">Submit your Rating</button>
                        </form>
                    </div>
                </div>
            </div>
