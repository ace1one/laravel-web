            ...
            <div class="col-lg-12 col-md-12 col-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-15 ms-4">
                                <a href="#" class="btn btns btn-small btn-primary btn_margin" id="get_route">Get
                                    route</a>
                                <a href="#" class="btn btns btn-small btn-primary btn_margin" id="back">&laquo;
                                    Back</a>
