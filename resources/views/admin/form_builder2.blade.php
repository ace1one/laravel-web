                            ...
                            <div class="container-fluid">
                                <div class="navbar-header">
                                    ...
                                    <form class="navbar-form navbar-left">
                                        <div class="mb-3">
                                            <select class="form-select" id="n-columns">
                                                <option value="1">1 Column</option>
                                                <option value="2">2 Columns</option>
                                            </select>
                                        </div>
                                        <button type="submit" class="btn btn-danger ms-3" data-clipboard-text="testing"
                            ...
                            <div class="row">
                                <div class="col-md-4 pd-col-4">
                                    ...
                                    <form role="form">
                                        ...
                                        <div class="form-check draggable">
                                            <label>
                                                <input type="checkbox">
                                                <span>Check me out</span>
                                            </label>
                                        </div>
                                        <div class=" draggable pd-right">
                                ...
                                <div class="col-md-8 pd-30">
                                    <div class="bg-color-form">
                                        <div class="text-muted empty-form text-center font-12">Drag & Drop elements to build
                                            form.</div>
