...
@section('content')
    ...
    <!-- Main content -->
    <section class="content my-3 px-3" id="invoice-stmt">
        <div class="row">
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header bg-success text-white">
                        <span><i class="livicon" data-name="tablet" data-size="16" data-loop="true" data-c="#fff"
                                data-hc="#fff"></i> Invoice from <bold>JOSH</bold></span>
                        <span class="float-end colors_right">
                    ...
                    <div class="card-body p-0 m-0">
                        ...
                        <div class="row p-3">
                            <div class="col-md-9 col-6 col-lg-9 mt-1">
                            ...
                            <div class="col-md-3 col-6 col-lg-3 pe-0">
                                <div id="invoice" class="text-end p-3">
                        ...
                        <div id="footer-bg">
                            ...
                            <hr>
                            <p class="text-center"><strong>Payment should be made by bank transfer or cheque made by payable
                                    to Josh</strong></p>
                            <div class="btn-section text-center">
                                <button type="button" class="btn btn_marTop button-alignment btn-info"
                                    data-bs-toggle="button">
                                    <a class="awhite" onclick="javascript:window.print();">
                                ...
                                <button type="button" class="btn btn_marTop button-alignment btn-secondary default_voice"
                                    data-bs-toggle="button">
                                    <a class="ablack">
                                        <i class="livicon" data-name="check" data-size="16" data-loop="true" data-c="#111"
                                            data-hc="#111"></i>
                                        Send Your Invoice
                                    </a>
                                </button>
