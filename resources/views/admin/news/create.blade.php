                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <div class=" {{ $errors->first('title', 'has-error') }}">
                                ...
                                <span class="form-text">{{ $errors->first('title', ':message') }}</span>
                            </div>
                            <div class='box-body pad  {{ $errors->first('content', 'has-error') }}'>
                                {!! Form::textarea('content', null, [
                                    'placeholder' => trans('blog/form.ph-content'),
                                    'class' => 'textarea form-control font_size14 textarea-style',
                                ]) !!}
                                <span class="form-text">{{ $errors->first('content', ':message') }}</span>
                            </div>
                        </div>
                        <!-- /.col-sm-8 -->
                        <div class="col-sm-4">
                            ...
                            <div class=" {{ $errors->first('category', 'has-error') }}">
                                ...
                                {!! Form::select(
                                    ...
                                    null,
                                    ['class' => 'form-control select2', 'id' => 'blog_category', 'placeholder' => trans('blog/form.select-category')],
                                ) !!}
                                <span class="form-text">{{ $errors->first('category', ':message') }}</span>
                            </div>

                            <div class=" {{ $errors->first('image', 'has-error') }}">
                                <label class="form-label col-12">@lang('blog/form.lb-featured-img')</label>
                                <div class="col-12 fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div class="fileinput-preview fileinput-exists thumbnail max-width-height1">
                                    ...
                                    <div>
                                        ...
                                        <span class="btn btn-primary fileinput-exists"
                                            data-bs-dismiss="fileinput">Remove</span>
                                    </div>
                                    <span class="form-text">{{ $errors->first('image', ':message') }}</span>
                                </div>
                            </div>
                            <div class=" col-12">
                                <button type="submit" class="btn btn-success">@lang('blog/form.publish')</button>
                                <a href="{!! URL::to('admin/news/create') !!}" class="btn btn-danger">@lang('blog/form.discard')</a>
                            </div>
                        </div>
                        <!-- /.col-sm-4 -->
                    </div>
