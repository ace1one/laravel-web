...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Scatter Charts</li>
    </ol>
</section>
<!-- Main content -->
...
<script src="{{ asset('js/admin/apexcharts_scatter.js') }}"></script>
