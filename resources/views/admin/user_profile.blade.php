...
@section('content')
    ...
    <section class="content user_profile px-3">
        <div class="row">
            <div class="col-md-4">
                <div class="">
                        ...
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail ">
                                @if (Sentinel::getUser()->pic)
                                    <img src="{!! url('/') . '/uploads/users/' . Sentinel::getUser()->pic !!}" alt="img" class="img-fluid " width="366px"
                                        height="218px" />
                                @elseif(Sentinel::getUser()->gender === 'male')
                                    <img src="{{ asset('images/authors/avatar3.png') }}" alt="img" class="img-fluid "
                                        width="366px" height="218px" />
                                @elseif(Sentinel::getUser()->gender === 'female')
                                    <img src="{{ asset('images/authors/avatar5.png') }}" alt="img" class="img-fluid "
                                        width="366px" height="218px" />
                                @else
                                    <img src="{{ asset('images/authors/no_avatar.jpg') }}" alt="img" class="img-fluid"
                                        width="366px" height="218px" />
                                @endif
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-6">
                                <div class="mag img-fluid">
                                    <br />
                                    <img data-bs-toggle="magnify" class="thumbnail img-fluid"
                                        src="{{ asset('img/authors/avatar.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="mag img-fluid">
                                    <br />
                                    <img data-bs-toggle="magnify" src="{{ asset('img/authors/avatar3.jpg') }}"
                                        alt="" class="thumbnail img-fluid">
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="mag img-fluid">
                                    <br />
                                    <img data-bs-toggle="magnify" src="{{ asset('img/authors/avatar7.jpg') }}"
                                        alt="" class="thumbnail img-fluid">
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="mag img-fluid">
                                    <br />
                                    <img data-bs-toggle="magnify" src="{{ asset('img/authors/avatar5.jpg') }}"
                                        alt="" class="thumbnail img-fluid">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-6">
                                <div class="mag img-fluid">
                                    <br />
                                    <img data-bs-toggle="magnify" src="{{ asset('img/authors/avatar4.jpg') }}"
                                        alt="" class="thumbnail img-fluid">
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                            ...
                            <div class="col-md-3 col-6">
                                <div class="mag img-fluid">
                                    <br />
                                    <img data-bs-toggle="magnify" src="{{ asset('img/authors/avatar2.jpg') }}"
                                        alt="" class="thumbnail img-fluid">
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="mag img-fluid">
                                    <br />
                                    <img data-bs-toggle="magnify" src="{{ asset('img/authors/avatar.jpg') }}"
                                        alt="" class="thumbnail img-fluid">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-6">
                                <div class="mag img-fluid">
                                    <br />
                                    <img data-bs-toggle="magnify" class="thumbnail img-fluid"
                                        src="{{ asset('img/authors/avatar1.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="mag img-fluid">
            ...
            <div class="col-md-8">
                <ul class="nav nav-tabs ul-edit">
                    <li class=" nav-item">
                        <a href="#tab-activity" data-bs-toggle="tab" class="nav-link active">
                            <i class="livicon" data-name="comments" data-size="16" data-c="#01BC8C" data-hc="#01BC8C"
                                data-loop="true"></i> Activity
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="#tab-messages" data-bs-toggle="tab" class="nav-link">
                            <i class="livicon" data-name="mail" data-size="16" data-c="#01BC8C" data-hc="#01BC8C"
                                data-loop="true"></i> Messages
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#tab-change-pwd" data-bs-toggle="tab" class="nav-link">
                ...
                <div class="tab-content" id="clothing-nav-content">
                    <div id="tab-activity" class="tab-pane fade show  active">
                        <div class="activity">
                            <div class="imgs-profile media d-flex">
                                <a class="float-start" href="#">
                                    <img class="media-object rounded-circle me-3"
                                        src="{{ asset('img/authors/avatar.jpg') }}" alt=""></a>
                            ...
                            <div class="imgs-profile media d-flex">
                                <a class="float-start" href="#">
                                    <img class="media-object rounded-circle img-fluid me-3"
                                        src="{{ asset('img/authors/avatar1.jpg') }}" alt=""></a>
                                <div class="media-body">
                                    ...
                                    <div class="media blog-media">
                                        <a class="float-start" href="#">
                                            <img class="media-object thumbnail me-3"
                                                src="{{ asset('img/authors/avatar2.jpg') }}" alt=""></a>
                            ...
                            <div class="imgs-profile media">
                                <a class="float-start" href="#">
                                    <img class="media-object rounded-circle me-3"
                                        src="{{ asset('img/authors/avatar3.jpg') }}" alt=""></a>
                                <div class="media-body">
                            ...
                            <div class="imgs-profile media d-flex">
                                <a class="float-start" href="#">
                                    <img class="media-object rounded-circle me-3"
                                        src="{{ asset('img/authors/avatar4.jpg') }}" alt=""></a>
                                <div class="media-body">
                                        ...
                                        <li>
                                            <a href="{{ asset('img/authors/avatar2.jpg') }}" data-rel="prettyPhoto">
                                                <img src="{{ asset('img/authors/avatar2.jpg') }}"
                                                    class="thumbnail img-fluid" alt=""></a>
                                        </li>
                                        <li>
                            ...
                            <div class="imgs-profile media d-flex">
                                <a class="float-start" href="#">
                                    <img class="media-object rounded-circle me-3"
                                        src="{{ asset('img/authors/avatar7.jpg') }}" alt=""></a>
                                <div class="media-body">
                            ...
                            <div class="imgs-profile media d-flex">
                                ...
                                <div class="media-body">
                                    ...
                                    <a href="{{ asset('img/authors/avatar.jpg') }}" data-rel="prettyPhoto"
                                        class="img-single">
                                        <img src="{{ asset('img/authors/avatar.jpg') }}" class="thumbnail img-fluid"
                                            alt=""></a>
                                </div>
                            </div>
                            <!-- media -->
                            ...
                            <tbody>
                                <tr data-messageid="1" class="unread">
                                    <td style="width:4%;" class="inbox-small-cells">
                                        <div class="form-check">
                                            <span>
                                                <input type="checkbox" class="mail-checkbox  form-check-input"></span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">John</a>
                                    </td>
                                ...
                                <tr data-messageid="2" class="unread">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">Marin</a>
                                    </td>
                                    <td class="view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                ...
                                <tr data-messageid="3">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">Jenny</a>
                                    </td>
                                    <td class="view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                ...
                                <tr data-messageid="4">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">Twiter</a>
                                    </td>
                                    <td class="view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                ...
                                <tr data-messageid="5">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">Grace</a>
                                    </td>
                                    <td class="view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            Ya comin' to our July webinar?
                                ...
                                <tr data-messageid="6">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">Kimy</a>
                                    </td>
                                    <td class="view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            Analysis on Views
                                ...
                                <tr data-messageid="7">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">Tony</a>
                                    </td>
                                    <td class="view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            Ya comin' to our July webinar?
                                ...
                                <tr data-messageid="8">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">Sandy</a>
                                    </td>
                                ...
                                <tr data-messageid="9">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">Avin</a>
                                    </td>
                                    <td class="view-message view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            Mobile-First Type & Layout
                                ...
                                <tr data-messageid="10">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">MJ</a>
                                    </td>
                                    <td class="view-message view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                ...
                                <tr data-messageid="11">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">Lofer</a>
                                    </td>
                                    <td class="view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                ...
                                <tr data-messageid="12">
                                    ...
                                    <td class="hidden-xs">
                                        <span class="view-message hidden-xs">
                                            <a href="{{ URL::to('admin/view_mail') }}">
                                                <img data-src="holder.js/25x25/#000:#fff"
                                                    class="rounded-circle img-fluid float-start" alt="Image">Renny</a>
                                        </span>
                                    </td>
                                    <td class="view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                ...
                                <tr data-messageid="13">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">Benny</a>
                                    </td>
                                    <td class="view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            This looks like borrows page
                                ...
                                <tr data-messageid="15">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">Mike</a>
                                    </td>
                                    <td class="view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            Ya comin' to our July webinar?
                                ...
                                <tr data-messageid="16">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">Clark</a>
                                    </td>
                                    <td class="view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            Make changes as needed
                                ...
                                <tr data-messageid="17">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">Robin</a>
                                    </td>
                                    <td class="view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            Mobile-First Type & Layout
                                ...
                                <tr data-messageid="18">
                                    ...
                                    <td class="view-message hidden-xs">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            <img data-src="holder.js/25x25/#000:#fff"
                                                class="rounded-circle img-fluid float-start" alt="Image">FB</a>
                                    </td>
                                    <td class="view-message view-message">
                                        <a href="{{ URL::to('admin/view_mail') }}">
                                            Ya comin' to our July webinar?
