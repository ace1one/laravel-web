...
@section('content')
    ...
    <!--section ends-->
    <section class="content my-3 px-3">
        <!--main content-->
        <div class="row">
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            @else
                                <h4 class="ps-2 text-muted">Currently there are no logs </h4>
                            @endif
                        </div>
                    </div>
                </div>
...
@section('footer_scripts')
    <script type="text/javascript" src="{{ asset('vendors/chartjs/js/chart.umd.js') }}"></script>
    <script type="text/javascript" src="{{ asset('vendors/sweetalert/js/sweetalert2.js') }}"></script>
    <script>
        Chart.defaults.responsive = true;
        Chart.defaults.scaleFontFamily = "'Source Sans Pro'";
        Chart.defaults.animationEasing = "easeOutQuart";
    </script>
    <script>
