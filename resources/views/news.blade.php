                ...
                <div class="row">
                            ...
                            @foreach ($popular as $item)
                                <div class="media my-2">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="text-danger small d-block">{!! date('d-m-Y', strtotime($item->created_at)) !!}</span>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                    ...
                    @if ($lifestyle->count())
                        ...
                        <div class="col-sm-6 lifestyle">
                            @if ($first['image'])
                                <img class="media-object me-3" src="{{ URL::to('/uploads/news/' . $first['image']) }}"
                                    alt="image">
                            @else
                                <i class="far fa-newspaper fa-5x"></i>
                            @endif
                            <div class="sports-height">
                                <a href="{{ route('news.show', $first['id']) }}" class="text-primary">
                                    <h4>{{ $first['title'] }}</h4>
                                </a>
                                <span class="text-danger small">{!! date('d-m-Y', strtotime($first['created_at'])) !!}</span>
                                <p>{!! $first['content'] !!}</p>
                            ...
                            @if ($first->image)
                                <a href="{{ route('news.show', $first['id']) }}" class="text-primary">
                                    <img class="img-fluid height_180"
                                        src="{{ URL::to('/uploads/news/' . $first->image) }}" alt="image">
                                </a>
                            @else
                                <i class="far fa-newspaper fa-5x"></i>
                            @endif
            ...
            <div class="col-md-4 ">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_default_1">
                                <div class="media d-flex">
                                    <div class="media-left">
                                        <a href="#">
                                            <img class="me-3" src="{{ asset('images/image_13.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <a href="#" class="fs-6">
                                        ...
                                        <span class="text-danger">May 10, 2015</span>
                                    </div>
                                </div>
                                <div class="media d-flex">
                                    <div class="media-left">
                                        <a href="#">
                                            <img class="me-3" src="{{ asset('images/image_14.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <a href="#" class="fs-6">
                                        ...
                                        <span class="text-danger">May 8, 2015</span>
                                    </div>
                                </div>
                                <div class="media d-flex">
                                    <div class="media-left">
                                        <a href="#">
                                            <img class="me-3" src="{{ asset('images/image_15.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <a href="#" class="fs-6">
                                        ...
                                        <span class="text-danger">May5, 2015</span>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab_default_2">
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="text-danger">May 13, 2015</span>
                                    </div>
                                </div>
                                <div class="media d-flex">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="text-danger">May 12, 2015</span>
                                    </div>
                                </div>
                                <div class="media d-flex">
                                    <div class="media-left">
                ...
                <div class="comments my-1 p-1">
                    ...
                    <div class="media d-flex">
                        <div class="media-left">
                            <a href="#">
                                <img class="me-3 rounded" src="{{ asset('images/image_13.jpg') }}" alt="image">
                            </a>
                        </div>
                        <div class="media-body">
                            <a href="#" class="fs-6">
                    ...
                    <div class="media d-flex">
                        ...
                        <div class="media-body">
                            ...
                            <span class="text-danger">May 11, 2015</span>
                        </div>
                    </div>
                    <div class="media d-flex">
                        <div class="media-left">
