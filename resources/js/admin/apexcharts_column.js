...
var options1 = {
    ...
    colors: [colorPalette.primary, colorPalette.success, colorPalette.orange],
    plotOptions: {
        bar: {
            horizontal: false,
            columnWidth: "55%",
...
var options6 = {
    ...
    plotOptions: {
        bar: {
            isDumbbell: true,
            columnWidth: 3,
            dumbbellColors: [[colorPalette.info, colorPalette.infoSubtle]],
        },
    },
    legend: {
        show: true,
    ...
    fill: {
        ...
        gradient: {
            type: "vertical",
            gradientToColors: [colorPalette.teal],
            inverseColors: true,
            stops: [0, 100],
        },
    },
...
var options7 = {
    ...
    legend: {
        ...
        markers: {
            fillColors: [colorPalette.success, colorPalette.info],
        },
    },
};
...
var options9 = {
    ...
    grid: {
        row: {
            colors: [colorPalette.white, colorPalette.secondarySubtle],
        },
    },
    xaxis: {
        labels: {
...

{
    ...
    chart12.addEventListener("dataPointSelection", function (e, chart, opts) {
    ...
    chart12.addEventListener("updated", function (chart) {
        updateQuarterChart(chart, "barQuarter");
    });
