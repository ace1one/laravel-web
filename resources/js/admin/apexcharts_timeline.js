    ...
    series: [
        {
            data: [
                ...
                },
                {
                    ...
                    fillColor: colorPalette.success,
                },
                {
                    x: "Coding",
                    y: [
                ...
                },
                {
                    ...
                    fillColor: colorPalette.warning,
                },
                {
                    x: "Deployment",
                    y: [
...
var options5 = {
    ...
    colors: [colorPalette.warning, colorPalette.success],
    plotOptions: {
        bar: {
            horizontal: true,
            isDumbbell: true,
            dumbbellColors: [colorPalette.warning, colorPalette.success],
        },
    },
    title: {
